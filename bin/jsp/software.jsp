...
client.</p>
<p><a
	href="http://www.whaleshark.org/interconnect/mac/Interconnect.jar"><strong>Interconnect</strong></a><br />
<em>Purpose</em>: Spot mapping and submission to the ECOCEAN Library<br />
<em>Requirements</em>: <a
	href="http://www.java.com/en/download/index.jsp">Java 1.5</a> or higher
</p>
<p><a href="http://www.getpaint.net/"><strong>Paint.NET</strong>
(Windows only, external link) </a><br />
<em>Purpose</em>: Image pre-processing <br />
<em>Requirements</em>: <a
	href="http://msdn2.microsoft.com/en-us/netframework/aa731542.aspx">.NET
2.0</a></p>
<p><a href="http://www.whaleshark.org/spot/spot.jnlp"><strong>Spot!</strong></a><br />
<em>Purpose</em>: Mapping 2D images to 3D models for perspective
correction <br />
<em>Requirements</em>: <a
	href="http://www.java.com/en/download/index.jsp">Java 1.5</a> or higher
