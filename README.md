...
<h2>History</h2>
Wildbook started as a collaborative software platform for globally-coordinated lynx (Rhincodon typus ) research as deployed in the Wildbook for Lynx (http://www.whaleshark.org). After many requests to use our software outside of lynx research, it is now an open source, community-maintained standard for mark-recapture studies.
