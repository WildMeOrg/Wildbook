...
function scSpecialEvent(dte) {
	...
	// every sunday
	if (intWeekday==0) {
		objEvent = new EventObj(m,d,y, "every sunday", null, "scEventBlue", null, null, "special");
		arrEvents[arrEvents.length] = objEvent;
	};
	
	// every 2nd saturday 
	if (intWeekday==6 && (intWeekOfMonth==1 || intWeekOfMonth==3) ) {
		objEvent = new EventObj(m,d,y, "1st and 3rd saturday", null, "scEventPurple", null, null, "special");
		arrEvents[arrEvents.length] = objEvent;
	};
	...
	// New Years Day
	if (m==1 && d==1) {
		objEvent = new EventObj(m,d,y, "New Years Day", null, "scEventBlue", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Martin Luther King Day, third Monday in January. 
	if (m==1 && intWeekday==1 && intWeekOfMonth==3) {
		objEvent = new EventObj(m,d,y, "M.L. King Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// President's Day, third Monday in February. 
	if (m==2 && intWeekday==1 && intWeekOfMonth==3) {
		objEvent = new EventObj(m,d,y, "Presidents Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// St. Valentines day
	if (m==2 && d==14) {
		objEvent = new EventObj(m,d,y, "Saint Valentines Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// St. Patricks day
	if (m==3 && d==17) {
		objEvent = new EventObj(m,d,y, "Saint Patricks Day", null, "scEventGreen", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Daylight Savings time begins, first Sunday in April
	if (m==4 && intWeekday==0 && intWeekOfMonth==1) {
		objEvent = new EventObj(m,d,y, "Begin Daylight Savings", null, "scEventGreen", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};
	
	// Mother's Day, second Sunday in May. 
	if (m==5 && intWeekday==0 && intWeekOfMonth==2) {
		objEvent = new EventObj(m,d,y, "Mothers Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	//Memorial Day, Last Monday in May. 
	if (m==5 && intWeekday==1 && blnLast==true) {
		objEvent = new EventObj(m,d,y, "Memorial Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Father's Day, third Sunday in June. 
	if (m==6 && intWeekday==0 && intWeekOfMonth==3) {
		objEvent = new EventObj(m,d,y, "Fathers Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// 4th of July
	if (m==7 && d==4) {
		objEvent = new EventObj(m,d,y, "Fourth of July", null, "scEventBlue", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Labor Day, first Monday in September. 
	if (m==9 && intWeekday==1 && intWeekOfMonth==1) {
		objEvent = new EventObj(m,d,y, "Labor Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Columbus Day, second Monday in October 
	if (m==10 && intWeekday==1 && intWeekOfMonth==2) {
		objEvent = new EventObj(m,d,y, "Colombus Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Daylight Savings Time ends, blnLast Sunday in October
	if (m==10 && intWeekday==0 && blnLast==true) {
		objEvent = new EventObj(m,d,y, "End Daylight Savings", null, "scEventBlack", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Halloween
	if (m==10 && d==31) {
		objEvent = new EventObj(m,d,y, "Halloween", null, "scEventOrange", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Thanksgiving Day, fourth Thursday in November. 
	if (m==11 && intWeekday==4 && intWeekOfMonth==4) {
		objEvent = new EventObj(m,d,y, "Thanksgiving", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Christmas
	if (m==12 && d==25) {
		objEvent = new EventObj(m,d,y, "Christmas Day", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};
	...
	if ( dte.equalsTo(dteGoodFriday)) {
		objEvent = new EventObj(m,d,y, "Good Friday", null, "scEventRed", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};

	// Easter Sunday 
	if ( dte.equalsTo(dteEaster)) {
		objEvent = new EventObj(m,d,y, "Easter Sunday", null, "scEventGreen", null, null, "holidays");
		arrEvents[arrEvents.length] = objEvent;
	};
