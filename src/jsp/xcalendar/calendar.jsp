...
<link rel="stylesheet" href="codebase/ext/dhtmlxscheduler_ext.css"
	...
	function init() {
		...
		scheduler.attachEvent("onClick", function (event_id, native_event_object){
			var myLink='http://'+'<%=CommonConfiguration.getURLLocation()%>'+'/encounters/encounter.jsp?number='+event_id;
		...
		scheduler.load((CommonConfiguration.getURLLocation()+"/CalendarXMLServer2?locCode=<%=locCode%>"));
...
<div id="page" style=''><jsp:include page="../header.jsp"
	flush="true">
