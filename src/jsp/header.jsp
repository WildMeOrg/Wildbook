...
<div>
  <ul id="pmenu">
    ...
    <li class="drop"><a
      ...
      <ul>
        <li><a
          href="http://<%=CommonConfiguration.getURLLocation() %>/index.jsp"
          class="enclose"
          style="margin: 0px 0 0px 0px; position: relative; width: 160px; height: 25px; z-index: 100;"><%=props.getProperty("intro")%></strong></a>
        </li>
    ...
    <li class="drop"><a
      ...
      <!--[if lte IE 6]></td></tr></table></a><![endif]--></li>
    <li class="drop">
      <a href="http://<%=CommonConfiguration.getURLLocation() %>/allIndividuals.jsp"
         style="margin: 0px 0 0px 0px; position: relative; width: 100px; height: 25px; z-index: 100;">
        <strong><%=props.getProperty("individuals")%>
        </strong><!--[if IE 7]><!--></a><!--<![endif]--> <!--[if lte IE 6]>
      <table>
        <tr>
          <td><![endif]-->
      <ul>
        <li><a href="http://<%=CommonConfiguration.getURLLocation() %>/allIndividuals.jsp"
               class="enclose"
    ...
    <li class="drop">
      ...
      <ul>
        ...
        <li>
          <a href="http://<%=CommonConfiguration.getURLLocation() %>/encounters/encounterSearch.jsp"
             class="enclose"
    ...
    <li><a href="http://<%=CommonConfiguration.getURLLocation() %>/contactus.jsp"
