            ...
            <td align="left" valign="top">
              ...
              <p>
                <object style="width: 810px; height: 540px;"
                  ...
                  <param name="src"
                         value="keenerview.swf?image_url=http://<%=CommonConfiguration.getURLLocation()%>/encounters/<%=number%>/<%=src%>"/>
                  <embed style="width: 810px; height: 540px;" type="application/x-shockwave-flash"
                         width="640" height="360"
                         src="keenerview.swf?image_url=http://<%=CommonConfiguration.getURLLocation()%>/encounters/<%=number%>/<%=src%>"></embed>
                </object>
              </p>
