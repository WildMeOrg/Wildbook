...
<p><strong>The following encounter(s) received the highest
  match values against a <%=side%>-side scan of encounter# <a
    href="http://<%=CommonConfiguration.getURLLocation()%>/encounters/encounter.jsp?number=<%=num%>"><%=num%>
  </a>.</strong></p>
    ...
    <td width="355" align="left" valign="top">
      <table width="100%" border="1" align="left" cellpadding="3">
        ...
        <tr align="left" valign="top">
            ...
            <table width="62">
              ...
              <tr>
                <td width="60" align="left"><a
                  href="http://<%=CommonConfiguration.getURLLocation()%>/individuals.jsp?number=<%=results[p].getIndividualName()%>"><%=results[p].getIndividualName()%>
                </a></td>
              </tr>
            </table>
          </td>
          ...
          <%} else {%>
          <td><a
            href="http://<%=CommonConfiguration.getURLLocation()%>/encounters/encounter.jsp?number=<%=results[p].encounterNumber%>"><%=results[p].encounterNumber%>
          </a></td>
          <%
            }
        ...
        <tr align="left" valign="top">
          <td>
            <table width="62">
              ...
              <tr>
                <td width="60" align="left"><a
                  href="http://<%=CommonConfiguration.getURLLocation()%>/individuals.jsp?number=<%=enc1.attributeValue("assignedToShark")%>"><%=enc1.attributeValue("assignedToShark")%>
                </a></td>
              </tr>
            </table>
          </td>
          ...
          <%} else {%>
          <td><a
            href="http://<%=CommonConfiguration.getURLLocation()%>/encounters/encounter.jsp?number=<%=enc1.attributeValue("number")%>"><%=enc1.attributeValue("number")%>
          </a></td>
          <%
            }
