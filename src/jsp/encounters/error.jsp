...
<a href="photographing.jsp"><img src="images/flag_en.gif" width="19"
	height="12" border="0" title="English" alt="English" /></a> <a
	href="photographing.jsp?langCode=de" title="Auf Deutsch"><img
	src="images/flag_de.gif" width="19" height="12" border="0"
	title="Deutsch" alt="Deutsch" /></a> <a
	href="photographing.jsp?langCode=fr" title="En fran&ccedil;ais"><img
	src="images/flag_fr.gif" width="19" height="12" border="0"
	title="Fran&ccedil;ais" alt="Fran&cedil;ais" /></a> <a
	href="photographing.jsp?langCode=es" title="En espa&ntilde;ol"><img
...
<div class="module">
<h3><%=more%> @ ECOCEAN.org</h3>
<ul class="left-nav1">
	<li class="ecocean"><a href="http://www.ecocean.org/"
		class="ecocean"><%=ws_info%></a></li>
	<li class="ecocean"><a
		href="http://www.ecocean.org/index.php?option=com_content&task=blogcategory&id=33&Itemid=102"
		class="ecocean"><%=contributors%></a></li>
	<li class="ecocean"><a
		href="http://www.ecocean.org/index.php?option=com_content&amp;task=view&amp;id=12&amp;Itemid=80"
		class="ecocean"><%=about%> ECOCEAN</a></li>
	<li class="ecocean"><a href="http://forum.ecocean.org/"
		class="ecocean">ECOCEAN <%=forum%></a></li>
	<li class="ecocean"><a href="http://blog.ecocean.org/"
		class="ecocean">ECOCEAN <%=blog%></a></li>
</ul>
...
<div id="maintext">
<h1 class="intro"><bean:message key="error.login" /></h1>
<br>
<p><bean:message key="error.tryagain" /> <html:link
	page="/welcome.jsp">
