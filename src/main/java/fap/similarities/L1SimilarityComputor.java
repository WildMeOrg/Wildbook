...
/**
 * L1 similarity computor, assumes that series are sorted by time (x axes) component.
 * Series must be the same length.
 * @author Zoltan Geller
 * @version 19.07.2010.
 */
public class L1SimilarityComputor extends SerializableSimilarityComputor {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Creates a new L1SimilarityComputor object.
	 */
	public L1SimilarityComputor() {}
