...
public class FileQueue extends Queue {
    ...
    throws IOException {
        ...
        File tmpFile = new File(queueDir, "addToQueue-" + qid + ".tmp"); // write to tmp file first
                                                                         // so it doesnt (yet) get
                                                                         // picked up by queue til
                                                                         // done
    ...
    throws IOException {
        ...
        if (activeFile.exists()) {
            ...
            // TODO keep a count maybe then skip over for real after N tries?  something like
            // that....
            return null;
        }
    ...
    // current algorithm is "oldest" (FIFO); filename simply must be a valid uuid (with no
    // extension)
