...
public class Project implements java.io.Serializable {
    ...
    public int numIndividuals(Shepherd myShepherd) {
        List<MarkedIndividual> individuals = null; // short circuit this because kitizen doesn't use project, and Shepherd.java doesn't yet need to be modified to include all of this:myShepherd.getMarkedIndividualsFromProject(this);
        if (individuals!=null) {
        ...
        if (encounters!=null) {
            for (final Encounter enc : encounters) {
                if (modifier!=null&&"addEncounterMetadata".equals(modifier)) {
                    ...
                    // } // short circuit this because kitizen doesn't use project, and Shepherd.java doesn't yet need to be modified to include all of this:
