...
public class WorkAppletHeadlessCognac {
  ...
  //constructor
  public WorkAppletHeadlessCognac(){}
  ...
  private void sendObject( ObjectOutputStream con , Object obj ) throws IOException{
    ...
    public static void main(String args[]){
        ...
        WorkAppletHeadlessCognac a = new WorkAppletHeadlessCognac();
        a.getGoing();
    }
    ...
    String nodeID="Cognac_"+(new Integer(nodeIdentifier)).toString();
        ...
        if(successfulConnect){
          ...
          //kick it like Poison!
            ...
            for(int d=0;d<resultsSize;d++){
              ...
              if((thisResult.getMatchValue()*thisResult.getAdjustedMatchValue())>=115) {numMatches++;}
            }
            ...
            if(resultsSize>0){
              ...
              BufferedReader in = new BufferedReader(new InputStreamReader(inputStreamFromServlet)); 
                  ...
                  else{System.out.println("Unsuccessful results transmit error!");}
