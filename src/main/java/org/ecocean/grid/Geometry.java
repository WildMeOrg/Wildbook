...
public final class Geometry {
     ...
     * @param anchor   Specifies the fixed point during extension. If anchor is 0.0, p0 is fixed and
     * p1 is adjusted. If anchor is 1.0, p1 is fixed and p0 is adjusted. If anchor is 0.5, the line
     * is adjusted equally in each direction and so on.
     */
     ...
     * @param zExtent Will upon return contain [xMin,xMax]. Unused (may be set to null) if z is
     * null.
     */
     ...
     *         -2 if lines are parallel and overlapping (x, y center) 0 if intesrection outside
     * segments (x,y set)
     ...
     * 2--'
     *
     * @param x      X coordinates of polyline of where arrow is positioned in the end. Must contain
     * at least two points.
     ...
     * @param inset  Specification of point 3 [0.0-1.0], 1.0 will put point 3 at distance length
     * from 1, 0.0 will put it at point 1.
