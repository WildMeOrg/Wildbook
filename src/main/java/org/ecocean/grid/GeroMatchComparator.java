...
public class GeroMatchComparator implements Comparator {
  
  public GeroMatchComparator(String side){
    this.side=side;
  }
  
  public GeroMatchComparator(){}
  ...
  public int compare(Object a, Object b) {
    ...
    if(side.equals("right")){
      a1.getGeroMatchDistance().doubleValue();
      b1_adjustedValue = b1.getGeroMatchDistance().doubleValue();
    }
    //assume left
    else{
      a1.getGeroMatchDistance().doubleValue();
