...
/**
 * matchObject is a temporary object used by the <code>shepherd</code> class to store unordered
 * match values tests
 */
public class MatchObject implements java.io.Serializable {
    ...
    public MatchObject(String individualName, double matchValue, double adjustedMatchValue,
        int numTriangles, ArrayList scores, String encounterNumber, String pointBreakdown,
        double[] logMbreakdown, String catalogSex, String date, double size) {
    ...
    public MatchObject(String individualName, double matchValue, int numTriangles,
