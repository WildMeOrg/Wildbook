...
public class ScanTask implements Serializable {
    ...
    /**
     * Use this constructor for new Groth scanTasks. Note: Input variable props must contain values
    ...
    public void addResult(ScanWorkItemResult wir) {
        ...
        // if this workItem is already done, record a collision for later use in optimization
        // analysis
        else {
            numCollisions++;
        }
