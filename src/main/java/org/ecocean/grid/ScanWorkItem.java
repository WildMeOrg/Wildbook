...
public class ScanWorkItem implements java.io.Serializable {
    ...
    /**
     * Returns true if a node is currently working on this object. This state times out after 60
     * seconds.
     */
    ...
    /**
     * Executes the work to be done on the remote node. Make sure to setDone() when execute has
