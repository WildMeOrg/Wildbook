 ...
 * <code>Encounters</code> are added to MarkedIndividual objects as multiple encounters are
 * associated with known individuals.
 * <p/>
 *
...
public class ScanWorkItemResult implements java.io.Serializable {
    ...
    public ScanWorkItemResult(String uniqueNumberOfTask, String uniqueNumberOfWorkItem,
        MatchObject result) {
        this.result = result;
