...
public class EC2RequestThread implements Runnable, ISharkGridThread {
    ...
    private void getEC2Instances() {
        try {
            ...
            /*
               //Step 2: create a security group CreateSecurityGroupRequest csgr = new CreateSecurityGroupRequest();
               ...
               //Step 3. Create a key pair CreateKeyPairRequest createKeyPairRequest = new CreateKeyPairRequest();
            ...
            /*
               ...
               // Initializes a Spot Instance Request RequestSpotInstancesRequest requestRequest = new RequestSpotInstancesRequest();
               ...
               // Amazon Linux AMI id or another of your choosing. LaunchSpecification launchSpecification = new LaunchSpecification();
               ...
               // Call the RequestSpotInstance API. RequestSpotInstancesResult requestResult = amazonEC2Client.requestSpotInstances(requestRequest);
