...
public class GridManager {
    ...
    // public ConcurrentHashMap<String,Integer> scanTaskSizes=new ConcurrentHashMap<String,
    // Integer>();
    ...
    public int getNumNodes() {
        ...
        // System.out.println("gridManager: Time diff is:
        // "+(currenTime-nodes.get(i).getLastCheckin()));
    ...
    public synchronized void checkinResult(ScanWorkItemResult swir) {
        try {
            ...
            // if ((!swir.getUniqueNumberTask().equals("TuningTask")) &&
            // (!swir.getUniqueNumberTask().equals("FalseMatchTask"))) {
    ...
    /*
     * Convenience method to speed ScanWorkItemCreationThread by always maintaining and
     * recalculating accurate counts of potential patterns to compare against.
     */
