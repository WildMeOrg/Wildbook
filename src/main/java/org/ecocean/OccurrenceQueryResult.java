...
public class OccurrenceQueryResult {
  ...
  public OccurrenceQueryResult(Vector<Occurrence> result, String jdoqlRepresentation, String queryPrettyPrint) {
    System.out.println("New OccurrenceQueryResult called. (jdoql,prettyPrint)= ("+jdoqlRepresentation+" ,"+queryPrettyPrint+")");
    this.result = result;
