...
public class StudySiteQueryResult {

  private Vector<StudySite> result;
  private String jdoqlRepresentation;
  private String queryPrettyPrint;

  public StudySiteQueryResult(Vector<StudySite> result, String jdoqlRepresentation, String queryPrettyPrint) {
    this.result = result;
    this.jdoqlRepresentation = jdoqlRepresentation;
    this.queryPrettyPrint = queryPrettyPrint;
  }

  public Vector<StudySite> getResult() {
    return result;
  }
