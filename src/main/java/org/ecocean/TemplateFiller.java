...
/**
 * Implementation of a simple text template. Loads a text template from a file, which can subsequently be used to substitute placeholder strings with
 * other strings in order to fill the template. Templates also retain a copy of their original state so they can be re-used.
 *
...
public class TemplateFiller {
     ...
     */
    public TemplateFiller(File file)
    throws IOException {
    ...
    /**
     * @return Whether the template contains the specified regular expression token. This is useful for conditional replacement (e.g. optimisation).
     *
    ...
    /**
     * @return Current text content of the template, or {@code null} if not loaded. This is the method to be used to retrieve the template contents
