...
/*
    NIBnumLoci = new NumInputBox (this,
                                  "Number of Loci",
                                  "How many loci are you examining?", 0, 0, 0, 1, 1,
 ...
 */
        ...
        /*
           NIBgenoTypes = new NumInputBox (this,
                                        ...
                                        "Enter in this order:  I1L1A1 I1L1A2 I1L2A1 I1L2A2... I2L1A1
                                           I2L1A2...", 2, 0, 2, 5, 1, GridBagConstraints.BOTH,
                                           GridBagConstraints.WEST, 10.0, 10.0, 1, 1, 1, 1
                                        );
         */

        // buClearInputs = new Button ("Clear Inputs");
        // MyFuns.constrain (this, buClearInputs, 0, 18, 1, 1, GridBagConstraints.NONE,
        // GridBagConstraints.WEST, 1.0, 1.0, 1, 1, 1, 1 );

        // buCalculate = new Button ("Calculate!");
        // MyFuns.constrain (this, buCalculate, 1, 18, 1, 1, GridBagConstraints.NONE,
        // GridBagConstraints.WEST, 1.0, 1.0, 1, 1, 1, 1 );

        // cbNamesPresent = new Checkbox ("Individual names are present as first item in each line",
        // null, false);
        // MyFuns.constrain (this, cbNamesPresent, 0, 19, 2, 1, GridBagConstraints.NONE,
        // GridBagConstraints.WEST, 1.0, 1.0, 1, 1, 1, 1 );
        ...
        // MyFuns.constrain (this, cbNoDivide, 0, 20, 2, 1, GridBagConstraints.NONE,
        // GridBagConstraints.WEST, 1.0, 1.0, 1, 1, 1, 1 );
        // cbNoDivide.setFont (new Font("Times", Font.BOLD, 12));

        // cbLowerTriangle = new Checkbox ("Only show lower triangle - makes smaller output", null,
        // false);
        // MyFuns.constrain (this, cbLowerTriangle, 0, 21, 2, 1, GridBagConstraints.NONE,
        // GridBagConstraints.WEST, 1.0, 1.0, 1, 1, 1, 1 );
...
/*
    NOBoutput		= new NumOutputBox (this,
                                            "Output",
                                            "Use copy/paste to move the results into other
                                               programs.", 2, 0, 22, 5, 1, GridBagConstraints.BOTH,
                                               GridBagConstraints.WEST, 10.0, 10.0, 1, 1, 1, 1
                );
 */
     ...
     * @parameter individualNames An array of MarkedIndividual.individualID values, with the first
     * one being the individual of interest for finding kin
    ...
    public static String getDistanceOuput(String individualNames[], String lociNames[],
        ...
        try {
            ...
            // numIndividuals = NIBgenoTypes.countValues () / (numLoci * 2 + (namesPresent ? 1 :
            // 0));
        ...
        // pb.finalize ();
        // output = output.concat ("There are " + numIndividuals + " individuals and " + numLoci + "
        // loci.\n");
        if (noDivide) {
    ...
    public void init() {
        ...
        /*
           ...
           if (s != null) NIBnumLoci.setText (s);

           s = this.getParameter ("genoTypes");
           if (s != null) NIBgenoTypes.setText (s.replace (',', '\n'));
         */
    }
}
