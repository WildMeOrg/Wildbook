...
public class DistWAD extends Ind2IndDistance {
    public float calculate(int genes1[], int genes2[]) {
        /*
                ...
                - when counting shared alleles, each allele found to be shared is counted as 1 - f,
                   where f is the frequency of that allele at that locus in the population as a
                   whole
         */
