...
public class TissueSample extends DataCollectionEvent {
    ...
    /**
     * Empty constructor required for JDO persistence. DO NOT USE
     */
    public TissueSample() {}
    ...
    public String getHTMLString() {
        ...
        if ((this.getAlternateSampleID() != null) && (!this.getAlternateSampleID().equals(""))) {
            paramValues += "     Alternate Sample ID: " + this.getAlternateSampleID() + "<br />";
        }
        if ((this.getPreservationMethod() != null) && (!this.getPreservationMethod().equals(""))) {
            paramValues += "     Preservation method: " + this.getPreservationMethod() + "<br />";
        }
        if ((this.getStorageLabID() != null) && (!this.getStorageLabID().equals(""))) {
            paramValues += "     Storage lab ID: " + this.getStorageLabID() + "<br />";
        }
        if ((this.getTissueType() != null) && (!this.getTissueType().equals(""))) {
            paramValues += "     Tissue type: " + this.getTissueType() + "<br />";
        }
        return paramValues;
    }
    ...
    public boolean hasMeasurement(String measurementType) {
        if ((analyses != null) && (analyses.size() > 0)) {
            ...
            for (int i = 0; i < numMeasurements; i++) {
                ...
                if (m.getAnalysisType().equals("BiologicalMeasurement")) {
                    BiologicalMeasurement f = (BiologicalMeasurement)m;
                    if ((f.getMeasurementType().equals(measurementType)) &&
                        (f.getValue() != null)) {
                        return true;
                    }
                }
    ...
    public BiologicalMeasurement getBiologicalMeasurement(String type) {
        if ((analyses != null) && (analyses.size() > 0)) {
            ...
            for (int i = 0; i < numMeasurements; i++) {
                ...
                if (m.getAnalysisType().equals("BiologicalMeasurement")) {
                    BiologicalMeasurement f = (BiologicalMeasurement)m;
                    if ((f.getValue() != null) && (f.getMeasurementType() != null) &&
                        (f.getMeasurementType().equals(type))) { return f; }
                }
            }
        }
        return null;
