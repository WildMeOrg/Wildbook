...
public class MicrosatelliteMarkersAnalysis extends GeneticAnalysis {
    ...
    public MicrosatelliteMarkersAnalysis(String analysisID, String sampleID,
    ...
    public MicrosatelliteMarkersAnalysis(String analysisID, String sampleID,
        String correspondingEncounterNumber, ArrayList<Locus> loci) {
        super(analysisID, type, correspondingEncounterNumber, sampleID);
        this.loci = loci;
    }
    ...
    public String getAllelesHTMLString() {
        ...
        if ((loci != null) && (loci.size() > 0)) {
            ...
            for (int i = 0; i < numLoci; i++) {
                returnString.append((loci.get(i).getHTMLString() + "<br />"));
            }
        }
