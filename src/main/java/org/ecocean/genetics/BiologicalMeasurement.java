...
public class BiologicalMeasurement extends GeneticAnalysis implements java.io.Serializable {
  ...
  public String getHTMLString(){
    String paramValues=super.getHTMLString();
    if((this.getMeasurementEventType()!=null)&&(this.getValue()!=null)&&(this.getUnits()!=null)&& (this.getSamplingProtocol()!=null)){paramValues+="     "+this.getMeasurementEventType()+" measurement: "+this.getValue().toString()+" "+this.getUnits()+" ("+this.getSampleID()+")<br />";}
  return paramValues;
  }
