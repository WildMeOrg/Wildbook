...
public class BiologicalMeasurement extends GeneticAnalysis implements java.io.Serializable {
    ...
    public BiologicalMeasurement(String sampleID, String analysisID,
        String correspondingEncounterNumber, String measurementType, Double value, String units,
    ...
    public String getHTMLString() {
        ...
        if ((this.getMeasurementType() != null) && (this.getValue() != null) &&
            (this.getUnits() != null) && (this.getSamplingProtocol() != null)) {
            paramValues += "     " + this.getMeasurementType() + " measurement: " +
                this.getValue().toString() + " " + this.getUnits() + " (" + this.getSampleID() +
                ")<br />";
        }
        return paramValues;
    }
