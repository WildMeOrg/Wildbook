...
public abstract class GeneticAnalysis implements java.io.Serializable {
    ...
    /**
     * Empty constructor required for JDO processing. DO NOT USE
     */
    public GeneticAnalysis() {}

    public GeneticAnalysis(String analysisID, String analysisType,
        String correspondingEncounterNumber, String sampleID) {
    ...
    public void setProcessingLabContactName(String newString) {
        this.processingLabContactName = newString;
    }

    public String getProcessingLabContactDetails() { return processingLabContactDetails; }
    public void setProcessingLabContactDetails(String newString) {
        this.processingLabContactDetails = newString;
    }
    ...
    public String getHTMLString() {
        ...
        if ((this.getProcessingLabName() != null) && (!this.getProcessingLabName().equals(""))) {
            paramValues += "     Processing lab name: " + this.getProcessingLabName() + "<br />";
        }
        if ((this.getProcessingLabTaskID() != null) &&
            (!this.getProcessingLabTaskID().equals(""))) {
            paramValues += "     Processing lab task ID: " + this.getProcessingLabTaskID() +
                "<br />";
        }
        if ((this.getProcessingLabContactName() != null) &&
            (!this.getProcessingLabContactName().equals(""))) {
            paramValues += "     Processing lab contact name: " +
                this.getProcessingLabContactName() + "<br />";
        }
        if ((this.getProcessingLabContactDetails() != null) &&
            (!this.getProcessingLabContactDetails().equals(""))) {
            paramValues += "     Processing lab contact details: " +
                this.getProcessingLabContactDetails() + "<br />";
        }
        return paramValues;
    }
}
