 ...
 * @author Colin Kingen
 *
 * A path is a collection of pointLocation objects. Each of these pointLocations contains GPS coordinent data, and a group of them for a particular
 * survey
 * gives you the path or paths that a team or individual followed during
 * a specific pointLocation in time.
 *
 * This is a very simple object that keeps track of those points, the SurveyTrack being the object above it.
 */
...
/*
    //returns a "representative" -- but much more manageable -- subset of points (i.e. not thousands of points) public List<PointLocation>
       getPointLocationsSubsampled() {
        //MAGIC GOES HERE!
 ...
 */
    ...
    public Long getComputedDuration() {
        ...
        if (s > e) {
            System.out.println("ERROR!  getComputedDuration() invalid (" + s + " > " + e +
                ") for " + this);
            return null;
        }
        return e - s;
