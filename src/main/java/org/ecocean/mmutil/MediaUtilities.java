...
public final class MediaUtilities {
    ...
    /**
     * Checks filename extension for supported image type. This method had been recreated here to allow static and centralized access;
    ...
    /**
     * Checks filename extension for supported video type. This method had been recreated here to allow static and centralized access;
     * original version requires a {@code Shepherd} instance.
     * @param filename filename of file to check
     * @return true if filename is supported, false otherwise
     */
    ...
    /**
     * Loads the specified image from the specified file, converting it to the sRGB color profile if necessary.
     * @param f file to which to save image
    ...
    /**
     * Creates an appropriate affine transform to correct the EXIF orientation specified. The orientation number should be obtained from the EXIF
     * IDFD0 Orientation metadata field.
    ...
    /**
     * Convenience method to convert a {@code BufferedImage} to the sRGB color space if not already compatible.
    ...
    /**
     * Convenience method that returns a scaled instance of the provided {@code BufferedImage}. Any transparency/alpha of the original image is not
     * preserved.
     *
    ...
    /**
     * Convenience method that returns a scaled instance of the provided {@code BufferedImage} with a text overlay. Any transparency/alpha of the
     * original image is not preserved. This is a simple implementation which was created solely for the purpose of reproducing thumbnail images with
     * a copyright message overlay, as done by the deprecated Sunwest Technologies Dynamic Images library.
     */
    ...
    /**
     * Extracts all the EXIF tags from the specified Metadata instance. This method ignores all GPS-related tags for data security reasons
