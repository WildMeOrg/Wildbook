...
/**
 * Utility class to allow convenient building of lists by method chaining. This class is just a
 * wrapper around a {@code List} implementation which provides convenience methods to quickly
 * create/edit lists. Lists can also be easily created using the standard method
...
public final class ListHelper<E> {
    ...
    /**
     * Creates a new instance using the specified list implementation, and with the specified
     * initial list item.
    ...
    /**
     * Creates a new instance (using an {@code ArrayList} implementation), and with the specified
     * initial list item.
     * @param <E> list item type
     * @param o initial item in list
     * @return {@code ListHelper} instance ready for further use.
    ...
    /**
     * Returns a single delimited string comprising the string representations of the constituent
     * items.
     * @param <E> list element type
    ...
    /**
     * Converts a list of items to a single delimited string comprising the string representations
    ...
    /**
     * Converts a list of items to a single delimited string comprising the string representations
     * of the constituent items, and also quotes items containing whitespace or quotes.
     * @param <E> list element type
     * @param list list of objects to convert
     * @param delim string delimiter to use between list items
     * @return String comprising quoted list contents sequentially concatenated with specified
     * delimiter
     */
