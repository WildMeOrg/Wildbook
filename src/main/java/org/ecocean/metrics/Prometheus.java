      ...
      for(i = 0; i< genuesNames.size(); i++){
        out.println("<p> All genues types: "+genuesNames.get(i)+"</p>");
          for(j = 0; j < specieNames.size(); j++){
            ...
            out.println("<p> Encounters for species: "+specieNames.get(i)+ ": " + specieEncounterNums + "</p>");
          }
            ...
            ArrayList<Encounter> speciesEquusQuagga1 = ms.getAllEncountersForSpecies(genuesNames.get(0), specieNames.get(0));
            int specQuagga = speciesEquusQuagga1.size();
            out.println("<p> Species Equus Quagga Encounters Try 1: "+speciesEquusQuagga1+"</p>");
            ArrayList<Encounter> speciesEquusQuagga2 = ms.getAllEncountersForSpecies(genuesNames.get(0), specieNames.get(1));
            out.println("<p> Species Equus Quagga Encounters Try 2: "+speciesEquusQuagga2+"</p>");
            ArrayList<Encounter> speciesEquusQuagga3 = ms.getAllEncountersForSpecies(genuesNames.get(0), specieNames.get(2));
