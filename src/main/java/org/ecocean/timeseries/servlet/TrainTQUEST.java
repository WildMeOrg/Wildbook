...
public class TrainTQUEST extends HttpServlet {
  ...
  //create text file so we can also use this training data in the Neuroph UI
    ...
    myShepherd.beginDBTransaction();
      ...
      try {
            ...
            TQuESTOperator op=new TQuESTOperator();
            ...
            op.tuneOperator(trajectories, labels, new NNClassifier());
            
            
            out.println("<p>I recommend the following values for the TQuEST algorithm when tuned on the "+genusSpecies +" dataset:<ul>");
            
            out.println("<li>Threshold: "+op.m_threshold);
            out.println("<li>Max Threshold: "+op.m_maxthreshold);
            out.println("<li>Min Threshold: "+op.m_minthreshold);
            out.println("<li>Step: "+op.m_step);
