    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (itasks.size() > 0) {
                ...
                itaskJson.put("numberEncounters",
                    Util.collectionSize(itasks.get(0).getEncounters()));
                itaskJson.put("numberMediaAssets",
                    Util.collectionSize(itasks.get(0).getMediaAssets()));
            }
