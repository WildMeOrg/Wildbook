...
public class TabularFeedback {
    ...
    public TabularFeedback(String[] colNames, boolean committing, PrintWriter out,
    ...
    public void printMissingPhotos() {
        // if (!isUserUpload) {
        out.println(
            "<div class=\"row\"><div class=\"col-col-sm-12 col-md-12 col-lg-12 col-xl-12\"><h2><em>Missing photos</em>("
            + this.missingPhotos.size() + "):</h2><ul>");
    ...
    public void printStartTable() {
        ...
        for (int i = 0; i < colNames.length; i++) {
            ...
            out.println("<th class=\"rotate\"><div><span class=\"tableFeedbackColumnHeader\">" +
                colNames[i] + "</span></div></th>");
        }
