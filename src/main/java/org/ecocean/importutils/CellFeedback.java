...
public class CellFeedback {
    ...
    public CellFeedback(Object value, boolean success, boolean isBlank) {
        ...
        System.out.println("new cellFeedback: got valueStr " + valueStr + " success: " + success +
            " and isBlank: " + isBlank);
    }
    ...
    public String titleStr() {
        ...
        if (!success)
            return
                    "ERROR: The import was unable to parse this cell. Please ensure that there are not letters or special characters in number fields (ex. lat/lon text or degree mark), formulas where there should be values or other data inconsistencies.";
