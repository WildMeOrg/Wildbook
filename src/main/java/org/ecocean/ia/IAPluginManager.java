...
// currently rootTask gets created here.  this could change in the future, to accommodate passing
// params around etc.
    ...
    public static List<Class> getAllEnabledPluginClasses(String context) {
        ...
        for (Class c : all) {
            ...
            try {
                ...
                throw new RuntimeException("ERROR: IAPluginManager.getAllEnabledPlugins() broke -- "
                   + ex.toString());
            }
