...
/*
 * An almost entirely static / functional class for printing html UI elements for editing class fields on pages such as occurrence.jsp. Note that this
 * class works only in conjunction with webapp/css/classEditTemplate.css and webapp/javascript/classEditTemplate.js
 */

public class ClassEditTemplate {
    public ClassEditTemplate() {}

    public static void invokeObjectMethod(Object obj, String methodName, String valueAsString)
    throws NoSuchMethodException {
        try {
            ...
            if (c == Double.class) {
                ...
                System.out.println("invokeObjectMethod: just invoked " + methodName +
                    " with value " + dbl);
            }
            if (c == Integer.class) {
            ...
            System.out.println("invokeObjectMethod: was not able to invoke " + methodName +
                " with value " + valueAsString);
            e.printStackTrace();
        }
    }

    public static Class findTypeOfField(Class parentClass, String fieldSetterName)
    throws NoSuchMethodException {
    ...
    public static boolean fieldHasType(Class parentClass, String fieldSetterName,
        Class candidateType) {
        try {
    ...
    public static void printStringFieldSearchRowCategories(String fieldName,
    ...
    public static void printStringFieldSearchRowFullCategories(String fieldName,
        javax.servlet.jsp.JspWriter out, Properties nameLookup, Shepherd myShepherd,
        Class fromClass)
    throws IOException, IllegalAccessException {
        // note how fieldName is variously manipulated in this method to make element ids and contents
        String displayName = getDisplayName(fieldName, nameLookup);
    ...
    public static void printStringFieldSearchRowCategories(String fieldName, String displayName,
        javax.servlet.jsp.JspWriter out, List<String> values)
    throws IOException, IllegalAccessException {
        // note how fieldName is variously manipulated in this method to make element ids and contents
        System.out.println("ClassEditTemplate is printing a categorical variable with options " +
            values);
        out.println("<tr id=\"" + fieldName + "Row\">");
    ...
    public static void printOutClassFieldModifierRows(Object obj, String[] fieldNames,
    ...
    public static void printOutClassFieldModifierRows(Object obj, String[] fieldNames,
        javax.servlet.jsp.JspWriter out, Properties posValueProps) {
        for (String fieldName : fieldNames) {
            try {
                if (Util.hasProperty(fieldName + "0", posValueProps)) {
                    printOutClassFieldModifierRow(obj, fieldName,
                        Util.getIndexedPropertyValues(fieldName, posValueProps), out);
    ...
    public static void printOutClassFieldModifierRow(Object obj, String fieldName,
        javax.servlet.jsp.JspWriter out)
    throws IOException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        String getterName = "get" + fieldName.substring(0,
    ...
    public static void printOutClassFieldModifierRow(Object obj, String fieldName,
        List<String> posValues, javax.servlet.jsp.JspWriter out)
    throws IOException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        String getterName = "get" + fieldName.substring(0,
            1).toUpperCase() + fieldName.substring(1);
        Method getter = obj.getClass().getMethod(getterName);
    ...
    public static void printOutClassFieldModifierRow(Object obj, Method getMethod,
        javax.servlet.jsp.JspWriter out)
    ...
    throws IOException, IllegalAccessException, InvocationTargetException {
        ...
        System.out.println("printing out " + fieldName + " value = " + printValue +
            " and options = " + posValues);
    ...
    public static void printOutClassFieldModifierRow(String fieldName, String printValue,
        String units, String inputName, javax.servlet.jsp.JspWriter out)
    throws IOException, IllegalAccessException, InvocationTargetException {
        out.println("<tr data-original-value=\"" + printValue + "\">");
        out.println("\t<td>" + fieldName + "</td>");
        out.println("\t<td>");
    ...
    // custom method to replicate a very specific table row format on this page
    public static void printOutClassFieldModifierRow(String fieldName, String printValue,
        List<String> posValues, String inputName, javax.servlet.jsp.JspWriter out)
    throws IOException, IllegalAccessException, InvocationTargetException {
        ...
        for (String valStr : posValues) {
            ...
            out.println("\t\t\t<option value=\"" + valStr + "\" " + thisSelStr + ">" + valStr +
                "</option>");
        }
        if (!printValuePrinted && Util.stringExists(printValue)) {
            // print value is selected.
            out.println("\t\t\t<option value=\"" + printValue + "\" " + SELECTED + ">" +
                printValue + "</option>");
        }
        out.println("\t\t</select>");
        out.println("\t</td>");
    ...
    public static void saveUpdatedFields(Object obj, HttpServletRequest request,
        Shepherd myShepherd)
    throws NoSuchMethodException {
        ...
        while (en.hasMoreElements()) {
            ...
            if (pname.indexOf(relevantParamPrefix) == 0) {
                String setterName = "set" + pname.substring(4,
                    5).toUpperCase() + pname.substring(5);
    ...
    public static void printUnmodifiableField(Object obj, Method getMethod,
        javax.servlet.jsp.JspWriter out)
    throws IOException, IllegalAccessException, InvocationTargetException {
        String className = obj.getClass().getSimpleName(); // e.g. "Occurrence"
        String classNamePrefix = ""; // e.g. "occ"
