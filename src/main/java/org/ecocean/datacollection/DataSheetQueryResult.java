...
public class DataSheetQueryResult {

  private Vector<DataSheet> result;
  private String jdoqlRepresentation;
  private String queryPrettyPrint;

  public DataSheetQueryResult(Vector<DataSheet> result, String jdoqlRepresentation, String queryPrettyPrint) {
    this.result = result;
    this.jdoqlRepresentation = jdoqlRepresentation;
    this.queryPrettyPrint = queryPrettyPrint;
  }

  public Vector<DataSheet> getResult() {
    return result;
  }
