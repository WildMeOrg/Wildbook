...
public abstract class DataPoint implements java.io.Serializable {
    ...
    private Integer configNo; // Serves as reference if parsed from the datapoint fields in
                              // commonConfiguration.properties
    private Integer number; // not-null only for sequential datapoints (e.g. egg weight 1, egg
                            // weight 2, egg weight 3)
    ...
    public abstract String toLabeledString(); // this makes it easy to check what type of DataPoint
                                              // a given datapoint is
