...
/**
 * DataCollectionEvent is an abstract base class that provides registration fields for common
 * metadata related to data that may be collected about an individual during an Encounter instance
 * of wildlife data in the field. The following types of classes are expected to extend
 * DataCollectionEvent:
 *   -PhotoVideoCollectionEvent class for managing photo and video data
 *   -GeneticCollectionEvent for managing haplotype and microsatellite marker data taken during an
 * Encounter instance
...
/**
 * correspondingEncounterNumber species which Encounter instance this data collection even
 * corresponds with
 */
