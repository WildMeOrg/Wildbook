...
public class Relationship implements java.io.Serializable {
    ...
    public Relationship(String type, String relatedCommunityName, MarkedIndividual individual1,
        MarkedIndividual individual2, String individualRole1, String individualRole2) {
        this.type = type;
    ...
    public Relationship(String type, MarkedIndividual individual1, MarkedIndividual individual2,
        String individualRole1, String individualRole2) {
        this.type = type;
        this.markedIndividualName1 = individual1.getIndividualID();
        this.markedIndividualName2 = individual2.getIndividualID();
        this.individual1 = individual1;
    ...
    public void setRelatedSocialUnitName(String name) {
        if (name != null) { relatedSocialUnitName = name; } else { relatedSocialUnitName = null; }
    }
    ...
    public void setMarkedIndividualRole1(String role) {
        if (role != null) { markedIndividualRole1 = role; } else { markedIndividualRole1 = null; }
    }
    ...
    public void setMarkedIndividualRole2(String role) {
        if (role != null) { markedIndividualRole2 = role; } else { markedIndividualRole2 = null; }
    }
    ...
    public void setRelatedComments(String comments) {
        if (comments != null) { relatedComments = comments; } else { comments = null; }
    }
    ...
    public void setMarkedIndividual1DirectionalDescriptor(String desc) {
        if (desc != null) { markedIndividual1DirectionalDescriptor = desc; } else {
            markedIndividual1DirectionalDescriptor = null;
        }
    }

    public void setMarkedIndividual2DirectionalDescriptor(String desc) {
        if (desc != null) { markedIndividual2DirectionalDescriptor = desc; } else {
            markedIndividual2DirectionalDescriptor = null;
        }
    }
    ...
    throws JSONException {
        ...
        if (this.getMarkedIndividualName1() != null)
            jobj.put("markedIndividualName1", this.getMarkedIndividualName1());
        if (this.getMarkedIndividualName2() != null)
            jobj.put("markedIndividualName2", this.getMarkedIndividualName2());
        if (this.getType() != null) jobj.put("type", this.getType());
        if (this.getMarkedIndividualRole1() != null)
            jobj.put("markedIndividualRole1", this.getMarkedIndividualRole1());
        if (this.getMarkedIndividualRole2() != null)
            jobj.put("markedIndividualRole2", this.getMarkedIndividualRole2());
        if (this.getBidirectional() != null) jobj.put("bidirectional", this.getBidirectional());
        if (this.getRelatedComments() != null)
            jobj.put("relatedComments", this.getRelatedComments());
        jobj.put("startTime", this.getStartTime());
        jobj.put("endTime", this.getEndTime());
        if (this.getRelatedSocialUnitName() != null)
            jobj.put("relatedSocialUnitName", this.getRelatedSocialUnitName());
    ...
    throws JSONException {
        if (getMarkedIndividual1() != null && !getMarkedIndividual1().canUserAccess(request))
            jobj.remove("individual1");
        if (getMarkedIndividual2() != null && !getMarkedIndividual2().canUserAccess(request))
            jobj.remove("individual2");
