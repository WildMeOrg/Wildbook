...
public class MediaAssetFactory {
    ...
    // NOTE!!!   acmId is NOT unique, so there could be more than one....  this will return "oldest"
    // (order by revision)
...
/*
    public static MediaAsset load(final Database db, final long id) throws DatabaseException
    {
 ...
 */
    ...
    public static void save(MediaAsset ma, Shepherd myShepherd) {
        ...
        // ma.setRevision();
        // for some reason (!?) parameters are getting lost when saving... sigh.  HACK for now...
        // lookout.  TODO
    ...
    /**
     * Delete this asset and any child assets from the given database. Does not delete any asset
     * files.
     *
