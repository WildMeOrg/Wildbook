...
/**
 * A Feature is a unique set of (arbitrary) data that contributes to helping with detection and
 * identification of images (or other data, e.g. audio). It is metadata that can be generated either
 * manually or automated (or both).
 */
public class Feature implements java.io.Serializable {
    static final long serialVersionUID = 8844223450443974780L;
    protected String id = null;

    // NOTE: a null for feature type we call the "unity" case -- meaning it serves only as a direct
    // map from Annotation to MediaAsset.
    // this can be thought of as "no" feature, or the "entire asset" feature, etc. (ostensibly
    // parameters would be ignored/useless, but that may change in the future)
 ...
 */
    ...
    public boolean isType(String tid) { // pass in string version of FeatureType.id (e.g.
                                        // "org.ecocean.fubar")
...
// System.out.println("setParametersAsString(" + p + ") called");
    ...
    /*
        ...
        for images, this might do some kind of clipping or rotation etc.  perhaps in the future this
           may need to return N MediaAssets?
        ideally we would break this out into neater classes, perhaps per MediaAsset type (image,
           video, sound)
     */
