...
/**
 * A FeatureType (still under development) will be the unique identifier of the content type of a
 * feature, such as "fluke trailing edge". Likely it should also include (as part of a compound id)
 * a version as well, so changes to meanings can be reflected here.
 *     etc.   TODO
 */
public class FeatureType implements java.io.Serializable {
    ...
    protected String id = null; // TODO maybe should take on form of "org.ecocean.flukeTrailingEdge"
                                // or something?
    ...
    // the myShepherd version is to call when initAll(myShepherd) has not been called to
    // pre-populate allTypes (on same persistence manager
