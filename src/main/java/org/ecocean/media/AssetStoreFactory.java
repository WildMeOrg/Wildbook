...
public class AssetStoreFactory {
    ...
    // TODO this *should* make an attempt to put the "default" one first (or generally order it in a
    // preferred way????) based on configuration
...
/*
    private static AssetStore buildAssetStore(final Integer id, final String name, final
       AssetStoreType type, final AssetStoreConfig config, final boolean writable)
    {
