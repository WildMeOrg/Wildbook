...
public class NestQueryResult {

  private Vector<Nest> result;
  private String jdoqlRepresentation;
  private String queryPrettyPrint;

  public NestQueryResult(Vector<Nest> result, String jdoqlRepresentation, String queryPrettyPrint) {
    this.result = result;
    this.jdoqlRepresentation = jdoqlRepresentation;
    this.queryPrettyPrint = queryPrettyPrint;
  }

  public Vector<Nest> getResult() {
    return result;
  }
