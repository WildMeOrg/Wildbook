 ...
 * Location ID (multiselect dropdown, loads from locationID.json)
 ...
 * Encounter dates (date (not datetime) from encounter)
 * Sex (multiselect set list) (loads from commonConfig)
 * Genus and species (dropdown) (loads from commonConfig))
 * Observation search (label:value search)
 * behavior (multiselect dropdown)
 * Group role (dropdown)
 * Life stage (dropdown, loads from commonConfig)
 ...
 * viewpoint (multiselect dropdown)
 * ia class (multiselect dropdown) (loads from ia.json)
