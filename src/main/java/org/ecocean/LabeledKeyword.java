...
public class LabeledKeyword extends Keyword {
    ...
    public static Map<String, List<String> > labelUIMap(Shepherd myShepherd,
    ...
    public static Map<String, List<String> > labelUIMapFromProperties(Shepherd myShepherd,
        HttpServletRequest request) {
        ...
        for (String key : propLabels.keySet()) {
            ...
            if (dbLabels.containsKey(key) && propLabels.containsKey(key) &&
                !dbLabels.get(key).containsAll(propLabels.get(key))) {
    ...
    public static Map<String, List<String> > labelUIMapFromDB(Shepherd myShepherd,
        HttpServletRequest request) {
    ...
    @Override public boolean isLabeledKeyword() {
        return true;
    }
}
