 ...
 */
        ...
        float pixelScale = 1;
        if ((clientWidth > 0) && (ma.getWidth() > 0))
            pixelScale = (float)ma.getWidth() / clientWidth;
 ...
 */
        ...
        if (spotMA != null) {
            ...
            System.out.println("SubmitSpotsAndTranform " +
                (spotMAisNew ? "generated a new" : "put spots on existing") + " spotMA id=" +
                spotMA.getId());
        } else {
            System.out.println(
