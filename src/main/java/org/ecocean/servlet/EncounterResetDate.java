        ...
        if ((request.getParameter("number") != null)) {
            ...
            try {
                ...
                if ((request.getParameter("datepicker") == null) ||
                    ...
                    /**
                     * Old method of parsing fixMe.setDay(Integer.parseInt(request.getParameter("day")));
                    ...
                    LocalDateTime reportedDateTime = new LocalDateTime(parser1.parseMillis(
                        request.getParameter("datepicker").replaceAll(" ", "T")));

                    // System.out.println("Day of month is: "+reportedDateTime.getDayOfMonth());
                    StringTokenizer str = new StringTokenizer(request.getParameter(
                    ...
                    fixMe.addComments("<p><em>" + request.getRemoteUser() + " on " +
                        ...
                        "</em><br>Changed encounter date from " + oldDate + " to " + newDate +
                        ".</p>");
            ...
            if (!locked) {
                ...
                out.println("<strong>Success:</strong> I have changed the encounter date from " +
                    oldDate + " to " + newDate + ".");
                ...
                String message = "The date of encounter " + request.getParameter("number") +
                    " was changed from " + oldDate + " to " + newDate + ".";
