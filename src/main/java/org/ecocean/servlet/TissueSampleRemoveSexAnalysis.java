...
public class TissueSampleRemoveSexAnalysis extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if ((request.getParameter("analysisID") != null) &&
            ...
            try {
                ...
                SexAnalysis mtDNA = myShepherd.getSexAnalysis(request.getParameter("sampleID"),
                ...
                enc.addComments("<p><em>" + request.getRemoteUser() + " on " +
                    (new java.util.Date()).toString() + "</em><br />" + "Removed sex analysis ID " +
            ...
            if (!locked) {
                ...
                out.println(
                    "<strong>Success!</strong> I have successfully removed the sex for tissue sample "
            ...
            out.println(
                "<strong>Error:</strong> I was unable to remove the sex analysis. I cannot find the encounter that you intended it for in the database.");
            out.println(ServletUtilities.getFooter(context));
        }
        out.close();
        myShepherd.closeDBTransaction();
