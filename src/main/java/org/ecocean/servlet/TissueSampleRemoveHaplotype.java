...
public class TissueSampleRemoveHaplotype extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        myShepherd.setAction("TissueSampleRemoveHaplotype.class");
        // set up for response
        ...
        if ((request.getParameter("analysisID") != null) &&
            ...
            try {
                ...
                MitochondrialDNAAnalysis mtDNA = myShepherd.getMitochondrialDNAAnalysis(
                ...
                enc.addComments("<p><em>" + request.getRemoteUser() + " on " +
                    ...
                    "Removed haplotype analysis ID " + request.getParameter("analysisID") +
                    ".<br />");
            ...
            if (!locked) {
                ...
                out.println(
                    "<strong>Success!</strong> I have successfully removed the haplotype for tissue sample "
