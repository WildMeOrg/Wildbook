...
public class StripePayment extends HttpServlet {
    ...
    throws IOException {
        ...
        Properties stripeProps = ShepherdProperties.getProperties("stripeKeys.properties", "",
            context);
        if (stripeProps == null) {
        ...
        if (planName.equals("none")) {
            try {
                ...
                out.println(
                    "No plan was selected, or form was missing other data. Card not charged, please try again.");
        ...
        if (planName.equals("none")) {
            try {
                ...
                String message = "Thank you for you donation to Wild Me of $" + amount +
                    " dollars. Wild Me is a lab under Conservation X Labs, a 5013c nonprofit, and donations are tax deductable in the United States.";
            ...
            try {
                ...
                response.sendRedirect(request.getScheme() + "://" +
                    CommonConfiguration.getURLLocation(request) + "/donationThanks.jsp");
            ...
            try {
                ...
                getServletContext().getRequestDispatcher("/createadoption.jsp" +
                    newQuery).forward(request, response);
            } catch (IOException ie) {
                System.out.println("Donation failed on redirect... IO exception.");
            } catch (Exception e) {
