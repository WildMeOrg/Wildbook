...
public class EncounterSetSubmitterID extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
	    ...
	    if ((request.getParameter("number") != null) && (request.getParameter("submitter")!=null) && (myShepherd.isEncounter(request.getParameter("number")))) {
	        ...
	        User encOwner = null;
	        if(enc.getSubmitterID()!=null) encOwner=myShepherd.getUser(enc.getSubmitterID());
	        
	        
	        if (
	        		(encOwner==null&&request.isUserInRole("orgAdmin")|| // case 1
	                ((encOwner!=null)&&ServletUtilities.isCurrentUserOrgAdminOfTargetUser(encOwner, request, myShepherd))|| // case 2
