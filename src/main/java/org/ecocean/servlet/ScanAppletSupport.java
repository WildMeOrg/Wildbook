...
public class ScanAppletSupport extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (gridSpaceAvailable) {
            ...
            if ((request.getParameter("action") != null) &&
                (request.getParameter("action").equals("getWorkItemGroup"))) {
            ...
            /*
               ...
               else if ((request.getParameter("action") != null) && (request.getParameter("action").equals("getEncounter")) &&
    ...
    /*
       //used for the old non-grid applet -- sends the appropriate encounter to scan back to the old applet public void getEncounter(Shepherd
          myShepherd, HttpServletRequest request, HttpServletResponse response) {
     ...
     */
    public void getWorkItemGroup(HttpServletRequest request, HttpServletResponse response,
        GridManager gm) {
        ...
        if ((request.getParameter("newEncounterNumber") != null) &&
            (!request.getParameter("newEncounterNumber").equals(""))) {
            ...
            try {
                ...
                // int totalWorkItems = gm.getNumWorkItemsCompleteForTask(request.getParameter("newEncounterNumber")) +
                // gm.getNumWorkItemsIncompleteForTask(request.getParameter("newEncounterNumber"));
                // change
        ...
        // start generic just grab the next available workItem group
            ...
            try {
                ...
                // get the items to transmit
                getUniqueWorkItemsGeneric(foundTask, gm, nd, holdResults, request, groupSize,
                    checkoutTimeout, false, 1, 1);
                ...
                e.printStackTrace();
                System.out.println(
                    "I'm in scanAppletSupport, generic request, caught an exception...");
    ...
    public boolean sendObject(HttpServletResponse response, Object encounterVector) {
        ...
        try {
            ...
            outputToApplet = new ObjectOutputStream(new BufferedOutputStream(new GZIPOutputStream(
            ...
            System.out.println(
                "Caught an error when attempting to return data via the sendEncounterList method of scanAppletSupport servlet");
            e.printStackTrace();
            return false;
        } finally {
            try {
    ...
    public synchronized void getUniqueWorkItems(Vector holdSWIs, HttpServletRequest request,
        int groupSize, long checkoutTimeout, GridManager gm) {
    ...
    public synchronized void getUniqueWorkItemsGeneric(boolean foundTask, GridManager gm,
        GridNode nd, Vector holdResults, HttpServletRequest request, int groupSize,
        long checkoutTimeout, boolean force, int totalWorkItems, int totalWorkItemsComplete) {
        // change
