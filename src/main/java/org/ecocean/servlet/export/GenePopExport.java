    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if ((request != null) && (request1 != null)) {
                ...
                if ((request.getParameter("searchNameField") != null) &&
                    (!request.getParameter("searchNameField").trim().equals("")) &&
                    (request1.getParameter("searchNameField") != null) &&
                    (!request1.getParameter("searchNameField").trim().equals(""))) {
                    additionalSearchString = ": " + request1.getParameter("searchNameField") +
                        " vs. " + request.getParameter("searchNameField");
                }
                ...
                for (int i = 0; i < numSearch1Individuals; i++) {
                    ...
                    if (i == (numSearch1Individuals - 1)) {
                        if ((request1.getParameter("searchNameField") != null) &&
                            (!request1.getParameter("searchNameField").equals(""))) {
                            indieID = request1.getParameter("searchNameField");
                ...
                for (int i = 0; i < numSearch2Individuals; i++) {
                    ...
                    if (i == (numSearch2Individuals - 1)) {
                        if ((request.getParameter("searchNameField") != null) &&
                            (!request.getParameter("searchNameField").trim().equals(""))) {
                            indieID = request.getParameter("searchNameField");
            ...
            out.println(
                "<p>Please let the webmaster know you encountered an error at: GenePopExport servlet.</p>");
            e.printStackTrace();
            myShepherd.rollbackDBTransaction();
            myShepherd.closeDBTransaction();
        }
