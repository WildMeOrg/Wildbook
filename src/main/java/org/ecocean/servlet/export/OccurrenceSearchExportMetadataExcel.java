  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
    ...
    try {
      ...
      try{
        ...
        OccurrenceQueryResult queryResult = OccurrenceQueryProcessor.processQuery(myShepherd, request, "year descending, month descending, day descending");
        rOccurrences = queryResult.getResult();

				Vector blocked = Occurrence.blocked(rOccurrences, request);
				if (blocked.size() > 0) {
        ...
        */
        ...
        int count = 0;
         ...
         for(int i=0;i<numMatchingOccurrences;i++){
            ...
            Label lNumberx3 = new Label(3, count, enc.getOccurrenceNumber());
            sheet.addCell(lNumberx3);
            Label lNumberx4 = new Label(4, count, ("http://" + CommonConfiguration.getURLLocation(request) + "/encounters/encounter.jsp?number=" + enc.getOccurrenceNumber()));
         ...
         } //end for loop iterating occurrences
