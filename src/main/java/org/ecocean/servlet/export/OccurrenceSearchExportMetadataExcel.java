...
public class OccurrenceSearchExportMetadataExcel extends HttpServlet {
    ...
    private void loadColHeaders(String[] headers)
    ...
    private void writeCell(String colName, Object value)
    throws jxl.write.WriteException {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try {
                OccurrenceQueryResult queryResult = OccurrenceQueryProcessor.processQuery(
                    myShepherd, request, "");
                ...
                String[] colHeaders = new String[] {
                    "occurrenceID", "dateTime", "decimalLatitude", "decimalLongitude", "taxonomies",
                        "individualCount", "groupBehavior", "comments", "modified",
                        "dateTimeCreated", "fieldStudySite", "fieldSurveyCode", "sightingPlatform",
                        "groupComposition", "humanActivityNearby", "initialCue", "seaState",
                        "seaSurfaceTemp", "swellHeight", "visibilityIndex", "effortCode",
                        "transectName", "transectBearing", "distance", "bearing",
                        "minGroupSizeEstimate", "maxGroupSizeEstimate", "bestGroupSizeEstimate",
                        "numAdults", "numJuveniles", "numCalves", "observer", "submitterID",
                        "encounterIDs"
                };
                ...
                for (int i = 0; i < numMatchingOccurrences; i++) {
                    ...
                    if (verbose)
                        System.out.println("OccurrenceSearchExportMetadataExcel: done row " +
                            currentRow);
                    currentRow++;
                ...
                out.println(
                    "<p>Please let the webmaster know you encountered an error at: OccurrenceSearchExportExcelFile servlet</p></body></html>");
