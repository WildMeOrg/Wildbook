...
public class CRCExportReport extends HttpServlet{
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
    ...
    myShepherd.setAction("CRCExportReport.class");
         ...
         for(int i=0;i<numMatchingEncounters;i++){
            ...
            for(int j=0;j<numAnnots;j++){
              ...
              if(annot.getMediaAsset()!=null){
                ...
                if(asset.webURL()!=null){
                  localFilename=asset.webURL().toString();
              ...
              //set the filename
                ...
                if(jobID!=null){
                  ...
                  for(int k=0;k<numJobs;k++){
                    ...
                    HashMap<String,Object> ires = IBEISIA.getTaskResultsAsHashMap(taskID, context);
