        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < numMatchingEncounters; i++) {
                    ...
                    Label lNumberx1 = new Label(1, count,
                        CommonConfiguration.getProperty("institutionCode", context));
                    sheet.addCell(lNumberx1);
                    Label lNumberx2 = new Label(2, count,
                        CommonConfiguration.getProperty("catalogCode", context));
                    ...
                    Label lNumberx7 = new Label(7, count,
                        CommonConfiguration.getProperty("citation", context));
                    sheet.addCell(lNumberx7);
                    Label lNumberx8 = new Label(8, count,
                        CommonConfiguration.getProperty("kingdom", context));
                    sheet.addCell(lNumberx8);
                    Label lNumberx9 = new Label(9, count,
                        CommonConfiguration.getProperty("phylum", context));
                    sheet.addCell(lNumberx9);
                    Label lNumberx10 = new Label(10, count,
                        CommonConfiguration.getProperty("class", context));
                    sheet.addCell(lNumberx10);
                    Label lNumberx11 = new Label(11, count,
                        CommonConfiguration.getProperty("order", context));
                    sheet.addCell(lNumberx11);
                    Label lNumberx13 = new Label(12, count,
                        CommonConfiguration.getProperty("family", context));
                    ...
                    if ((enc.getGenus() != null) && (enc.getSpecificEpithet() != null)) {
                        ...
                        StringTokenizer str = new StringTokenizer(CommonConfiguration.getProperty(
                            "genusSpecies0", context), " ");
                    ...
                    if (enc.getHour() > -1) {
                        Label lNumberx22 = new Label(21, count,
                            (enc.getHour() + ":" + enc.getMinutes()));
                        sheet.addCell(lNumberx22);
                    }
                    Label lNumberx23 = new Label(22, count,
                        StringEscapeUtils.unescapeHtml4(enc.getLocation()));
                    ...
                    if (defaultGpsDesired && (enc.getLocationCode() != null) &&
                        (!enc.getLocationCode().equals(""))) {
                        try {
                    ...
                    if (enc.getComments() != null) {
                        Label lNumberx26 = new Label(26, count,
                            StringEscapeUtils.unescapeHtml4(enc.getComments().replaceAll("<br>",
                                ". ").replaceAll("\n", "").replaceAll("\r", "")));
                    ...
                    if (enc.getIndividual() != null) {
                        Label lNumberx28 = new Label(28, count,
                            StringEscapeUtils.unescapeHtml4(enc.getIndividual().getDisplayName(
                            request, myShepherd)));
