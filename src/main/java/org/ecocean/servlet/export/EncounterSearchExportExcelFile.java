  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
    ...
    try {
      ...
      //let's write out headers for the OBIS export file
        ...
        Label label0 = new Label(0, 0, "SHARK-ID is unique");
        sheet.addCell(label0);
        Label label1 = new Label(1, 0, "SHARK-ID");
        sheet.addCell(label1);
        Label label2 = new Label(2, 0, "IMAGE NAME");
        sheet.addCell(label2);
        Label label2a = new Label(3, 0, "LOCATION");
        sheet.addCell(label2a);
        Label label3 = new Label(4, 0, "YEAR");
        sheet.addCell(label3);
        Label label5 = new Label(5, 0, "MONTH");
        sheet.addCell(label5);
        Label label6 = new Label(6, 0, "GENDER");
        sheet.addCell(label6);
        Label label7 = new Label(7, 0, "FLANK");
        sheet.addCell(label7);
        Label label8 = new Label(8, 0, "PHOTOGRAPHER");
        sheet.addCell(label8);
        Label label9 = new Label(9, 0, "MATCH");
        sheet.addCell(label9);
        Label label10 = new Label(10, 0, "MIGRATION");
        sheet.addCell(label10);
        Label label11 = new Label(11, 0, "HOOK MARK OTHER NONE");
        sheet.addCell(label11);
        Label label12 = new Label(12, 0, "LASER");
        sheet.addCell(label12);
        Label label13 = new Label(13, 0, "PRE CAUD SIZE CM");
        sheet.addCell(label13);
        Label label14 = new Label(14, 0, "TOTAL SIZE CM");
        sheet.addCell(label14);
        Label label15 = new Label(15, 0, "AGE");
        sheet.addCell(label15);
        Label label16 = new Label(16, 0, "WATER TEMP");
        sheet.addCell(label16);
        Label label17 = new Label(17, 0, "LAT");
        sheet.addCell(label17);
        Label label18 = new Label(18, 0, "LONG");
        sheet.addCell(label18);
        Label label19 = new Label(19, 0, "# SHARKS AT CAVE (MP)");
        sheet.addCell(label19);
        Label label20 = new Label(20, 0, "# SHARKS AT OVERHANG (MP)");
        sheet.addCell(label20);
        Label label21 = new Label(21, 0, "COMMENTS");
