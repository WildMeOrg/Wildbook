...
public class ScanTaskHandlerIVEC extends HttpServlet {
			...
			if ((action.equals("removeTask"))&&(request.getParameter("taskID")!=null)) {
				...
				if(!locked&&successfulStore) {
					...
					try{
						...
						es.execute(new IVECRequestThread("cognac.ivec.org", "jholmberg", "wa?digra"));
						es.execute(new IVECRequestThread("xe.ivec.org", "jholmberg", "wa?digra"));
