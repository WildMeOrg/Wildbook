    ...
    try {
      ...
      if (currentUsername!=null) {
        ...
        */
        ...
        if(request.isUserInRole("admin") ) {  // short circuit this because kitizen doesn't use collaborations this way. Presumably, only admins will need to use merge in kitizen, and user.java doesn't yet need to be modified to include all of this:|| (Collaboration.canUserFullyEditMarkedIndividual(mark1, request) && Collaboration.canUserFullyEditMarkedIndividual(mark2, request))
