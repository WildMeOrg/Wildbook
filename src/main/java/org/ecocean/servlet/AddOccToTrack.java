...
public class AddOccToTrack extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (trackID != null) {
            try {
                ...
                message +=
                    "<p style=\"color:red;\"><strong>Error: </strong> There was not a survey track available for the ID submitted.</p>";
                e.printStackTrace();
            }
        } else {
            message +=
                "<p style=\"color:red;\"><strong>Error: </strong>A valid survey track ID must be submitted.</p>";
        }
        Occurrence occ = null;
        if (occID != null && st != null) {
            try {
                ...
                if (!st.hasOccurrence(occ)) {
                    ...
                    message +=
                        "<p><strong>Success: </strong>The occurrence was added to the selected survey track.</p>";
                } else {
                    System.out.println("Already has this occurrence!");
                    message +=
                        "<p style=\"color:red;\"><strong>Error: </strong>The occurrence entered already belongs to this survey track.</p>";
                }
            } catch (Exception e) {
                myShepherd.rollbackDBTransaction();
                message +=
                    "<p style=\"color:red;\"><strong>Error: </strong> There was not a occurrence with that ID to retrieve.</p>";
                e.printStackTrace();
            }
        } else {
            message +=
                "<p style=\"color:red;\"><strong>Error: </strong>A valid occurrence ID must be submitted.</p>";
        }
    ...
    private void printResultMessage(HttpServletRequest request, String context, String surveyID) {
        try {
            ...
            message += "<p><strong>Back: </strong><a href=\"/surveys/survey.jsp?surveyID=" +
                surveyID + "\">Return to Survey Page</a></p>";
            out.println(message);
