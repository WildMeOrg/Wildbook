...
public class UserResetAcceptedUserAgreement extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // success!!!!!!!!
            ...
            out.println(
                (
                "<strong>Success!</strong> I have successfully reset the User Agreement status for all users. Each will now need to accept the User Agreement again after login."));
            out.println("<p><a href=\"" + request.getScheme() + "://" +
                CommonConfiguration.getURLLocation(request) +
                "/appadmin/users.jsp?context=context0\">Return to the User Administration page.</a></p>\n");
        ...
        // failure due to exception
            ...
            out.println(ServletUtilities.getHeader(request));
            out.println(
                "<strong>Failure!</strong> I could not reset User Agreement status. Please check the server log for the relevant exception.");
