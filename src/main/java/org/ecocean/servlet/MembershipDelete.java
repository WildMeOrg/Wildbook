        ...
        if (j != null) {
            ...
            try {
                ...
                if (mi != null) {
                    ...
                    System.out.println("I think I removed the indy from the SocialUnit: " +
                        (!su.hasMarkedIndividualAsMember(mi)));
                    if (su.getMarkedIndividuals().size() < 1) {
                        System.out.println("[INFO]: No more members left in SocialUnit " +
                            su.getSocialUnitName() + ", deleting.");
