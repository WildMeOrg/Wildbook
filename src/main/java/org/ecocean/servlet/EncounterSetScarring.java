    ...
    throws ServletException, IOException {
        ...
        if (request.getParameter("scars") != null) {
            ...
            if (!locked) {
                ...
                out.println("<strong>Success:</strong> Encounter scarring has been updated from " +
                    oldScar + " to " + scar + ".");
                ...
                String message = "Encounter " + request.getParameter("number") +
                    " scarring has been updated from " + oldScar + " to " + scar + ".";
                ...
                out.println(
                    "<strong>Failure:</strong> Encounter scarring was NOT updated because another user is currently modifying this reconrd. Please try to reset the scarring again in a few seconds.");
                // out.println("<p><a href=\"http://" + CommonConfiguration.getURLLocation(request) + "/encounters/encounter.jsp?number=" +
                // request.getParameter("number") + "\">Return to encounter #" + request.getParameter("number") + "</a></p>\n");
