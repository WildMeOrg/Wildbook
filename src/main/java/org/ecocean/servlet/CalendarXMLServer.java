...
public class CalendarXMLServer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            grp.addMember("individual").addMember("sex").addMember("day").addMember(
                "month").addMember("year");
            ...
            EncounterQueryResult queryResult = EncounterQueryProcessor.processQuery(myShepherd,
                request, "individual.individualID descending");
                        ...
                        if (tempEnc != null) {
                            if (tempEnc.getIndividual() != null) {
                                ...
                                if ((sharky.getSex() != null) &&
                                    (!sharky.getSex().toLowerCase().equals("unknown"))) {
                                ...
                                if (tempEnc.getIndividual() != null) {
                                    ...
                                    displayName = tempEnc.getIndividual().getDisplayName(request,
                                        myShepherd);
                                }
                                String outputXML = "<event id=\"" + tempEnc.getCatalogNumber() +
                                    "\">";
                                outputXML += "<start_date>" + tempEnc.getYear() + "-" +
                                    tempEnc.getMonth() + "-" + tempEnc.getDay() + " " + "01:00" +
                                    "</start_date>";
                                outputXML += "<end_date>" + tempEnc.getYear() + "-" +
                                    tempEnc.getMonth() + "-" + tempEnc.getDay() + " " + "01:00" +
                                    "</end_date>";
                                outputXML += "<text><![CDATA[" + displayName + "(" + sex +
                                    ")]]></text>";
                                outputXML += "<details></details></event>";
                                out.println(outputXML);
                            } else {
                                String sex = "-";
                                if ((tempEnc.getSex() != null) &&
                                    (!tempEnc.getSex().toLowerCase().equals("unknown"))) {
                                ...
                                outputXML += "<start_date>" + tempEnc.getYear() + "-" +
                                    ...
                                    "</start_date>";
                                outputXML += "<end_date>" + tempEnc.getYear() + "-" +
                                    tempEnc.getMonth() + "-" + tempEnc.getDay() + " " + "01:01" +
                                    "</end_date>";
        ...
        catch (Exception cal_e) { cal_e.printStackTrace(); } finally {
