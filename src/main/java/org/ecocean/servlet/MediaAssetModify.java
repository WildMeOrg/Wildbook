...
public class MediaAssetModify extends HttpServlet {
    private static final Logger log = LogManager.getLogger(MediaAssetModify.class);
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (ma == null) {
                throw new IOException("No MediaAsset in database with id " +
                ...
                if (request.getParameter("datetime") != null) {
                    ...
                    res.put("setDateTime",
                        DateTime.parse(request.getParameter("datetime")).toString());
                }
            }
