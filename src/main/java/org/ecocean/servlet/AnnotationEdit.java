...
public class AnnotationEdit extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (user != null)
            isAdmin = myShepherd.doesUserHaveRole(user.getUsername(), "admin", context);
        if (!isAdmin) {
            ...
            if (swapId != null) {
                ...
                if (swapId.equals(annId) || (swapAnnot == null)) {
                    ...
                    if ((enc1 == null) || (enc2 == null)) {
                        ...
                        System.out.println(
                            "INFO: AnnotationEdit swapped MarkedIndividual ids - enc=" +
                            enc1.getCatalogNumber() + "[annot=" + annot.getId() + "]=>(" +
                            enc1.getIndividualID() + "); enc=" + enc2.getCatalogNumber() +
                            "[annot=" + swapAnnot.getId() + "]=>(" + enc2.getIndividualID() + ")");
                ...
                if (swapEncAnnotId.equals(annId) || (swapAnnot == null)) {
                    ...
                    if ((enc1 == null) || (enc2 == null)) {
                        ...
                        System.out.println(
                            "INFO: AnnotationEdit swapped Annotations between Encounters; ORIGINAL: (enc="
                            + enc1.getCatalogNumber() + " + annot=" + annot.getId() +
                            ") and (enc=" + enc2.getCatalogNumber() + " + annot=" +
                            swapAnnot.getId() + ")");
                        rtn.put("success", true);
                ...
                try {
                    Feature feat = (Feature)(myShepherd.getPM().getObjectById(
                        myShepherd.getPM().newObjectIdInstance(Feature.class, fid), true));
                    ...
                    if ((feat == null) || (enc == null)) {
                        ...
                        rtn.put("error",
                            "Cannot remove Encounter which has more than one Annotation");
                        ...
                        System.out.println(
                            ...
                            enc.getCatalogNumber() + "," + annot.getId() + "," + feat.getId() +
                            "]" + note);
                        rtn.put("success", true);
                    }
                } catch (Exception ex) {
                    rtn.put("error",
                        "ERROR: " + ex.toString() + " with featureId=" + fid + " and encounterId=" +
                        eid);
                }
