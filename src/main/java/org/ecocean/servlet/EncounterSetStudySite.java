...
public class EncounterSetStudySite extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    System.out.println("!");
    System.out.println("!");
    System.out.println("EncounterSetStudySite!");
    ...
    if (request.getParameter("stuID") != null) {
      ...
      System.out.println("Encounter #"+encNum+" isNull = "+(changeMe==null));


      changeMe.setDWCDateLastModified();
      try {
