...
public class LightRestServlet extends HttpServlet
{
    ...
    private static final String[] Encounter_Light_Str_Fields = {"catalogNumber","individualID","sex", "guid", "otherCatalogNumbers","verbatimLocality","locationID","submitterName","submitterProject","genus","specificEpithet", "dwcDateAdded","modified"};
