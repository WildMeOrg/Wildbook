    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (myShepherd.getUser(username) != null) {
                ...
                if ((CommonConfiguration.getProperty("showUserAgreement",
                    context) != null) && (CommonConfiguration.getProperty("userAgreementURL",
                        context) != null) && (CommonConfiguration.getProperty("showUserAgreement",
                        context).equals("true")) && (!user.getAcceptedUserAgreement())) {
                    System.out.println("LoginUser: user " + username +
                        " needs to sign User Agreement. Redirecting...");
                    subject.logout();
                    redirectUser = true;
                    url = CommonConfiguration.getProperty("userAgreementURL", context);
                } else {
                    System.out.println("LoginUser: user " + username +
                        " has signed agreement. Redirecting...");
