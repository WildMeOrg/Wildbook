    ...
    throws ServletException, IOException {
        ...
        if ((myShepherd.isAdoption(adoptionID))) {
            ...
            try {
                ...
                // File thisEncounterDir=new File(((new
                // File(".")).getCanonicalPath()).replace('\\','/')+"/"+CommonConfiguration.getAdoptionDirectory()+File.separator+request.getParameter("number"));
                File thisAdoptionDir = new File(adoptionsDir.getAbsolutePath() + "/" +
                    request.getParameter("adoptionID"));
            ...
            if (!locked) {
                ...
                out.println("<strong>Success!</strong> I have successfully removed adoption " +
                    adoptionID + ". However, a saved copy an still be restored.");
                ...
                out.println(ServletUtilities.getHeader(request));
                out.println(
                    "<strong>Failure!</strong> I failed to delete this adoption. Check the logs for more details.");
