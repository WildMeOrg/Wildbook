        ...
        if (myShepherd.isEncounter(encNum)) {
            ...
            try {
                ...
                if (releaseDateStr != null && releaseDateStr.trim().length() > 0) {
                    ...
                    DateTime reportedDateTime = parser1.parseDateTime(request.getParameter(
                        "releasedatepicker"));
                    ...
                    enc.addComments("<p><em>" + request.getRemoteUser() + " on " +
                        ...
                        "</em><br>Changed encounter release date from " + oldReleaseDate + " to " +
                        newReleaseDate + ".</p>");
                } else {
            ...
            if (badFormat) {
                ...
                out.println(
                    "<p><strong>Success!</strong> I have successfully set the following new release date: "
                    + newReleaseDate);
                out.println(sb.toString());
                // out.println("<p><a
