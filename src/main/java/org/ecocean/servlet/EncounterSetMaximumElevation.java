    ...
    throws ServletException, IOException {
        ...
        if (request.getParameter("number") != null) {
            ...
            try {
                ...
                if ((request.getParameter("elevation") != null) &&
                    (!request.getParameter("elevation").equals(""))) {
                ...
                changeMe.addComments("<p><em>" + request.getRemoteUser() + " on " +
                    ...
                    "</em><br>Changed reported elevation from " + oldElev + " to " + newElev +
                    ".</p>");
            } catch (NumberFormatException nfe) {
                System.out.println(
                    "Bad numeric input on attempt to change elevation for the encounter.");
                locked = true;
                nfe.printStackTrace();
            ...
            if (!locked) {
                ...
                out.println("<strong>Success:</strong> Encounter elevation has been updated from " +
                    oldElev + " to " + newElev + ".");
                response.setStatus(HttpServletResponse.SC_OK);

                // out.println("<p><a href=\"individualSearchResults.jsp\">View all individuals</a></font></p>");
                // out.println(ServletUtilities.getFooter(context));
                String message = "The elevation of encounter " + request.getParameter("number") +
                    " has been updated from " + oldElev + " meters to " + newElev + " meters.";
                ...
                out.println(
                    "<strong>Failure:</strong> Encounter elevation was NOT updated because another user is currently modifying the record for this encounter, or the value input does not translate to a valid elevation number.");
                out.println(
