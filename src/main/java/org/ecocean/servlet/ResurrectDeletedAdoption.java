...
public class ResurrectDeletedAdoption extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if ((request.getParameter("number") != null) && (!myShepherd.isAdoption(encounterNumber))) {
            ...
            // File(".")).getCanonicalPath()).replace('\\','/')+"/"+CommonConfiguration.getAdoptionDirectory()+File.separator+request.getParameter("number")+File.separator+datFilename);
            File thisAdoptionDat = new File(adoptionsDir.getAbsolutePath() + "/" +
            ...
            if (thisAdoptionDat.exists()) {
                try {
                    ...
                    // restoreMe.addComments("<p><em>"+request.getRemoteUser()+" on "+(new java.util.Date()).toString()+"</em><br>"+"Restored this
                ...
                if (!locked) {
                    ...
                    out.println("<strong>Success!</strong> I have successfully restored adoption " +
                    ...
                    out.println("<p><a href=\"http://" +
                        ...
                        "/adoptions/adoption.jsp?number=" + encounterNumber +
                        "\">Return to adoption " + encounterNumber + "</a></p>\n");
                    ...
                    out.println(ServletUtilities.getHeader(request));
                    out.println(
                        "<strong>Failure!</strong> This adoption cannot be restored due to an unknown error. Please contact the webmaster.");
                ...
                out.println(ServletUtilities.getHeader(request));
                out.println(
                    "<strong>Failure!</strong> I could not find the DAT file to restore this adoption from.");
            ...
            out.println(ServletUtilities.getHeader(request));
            out.println(
                "<strong>Error:</strong> I was unable to resurrect the adoption because I did not know which adoption you were referring to, or this adoption still exists in the database!");
            // out.println("<p><a
