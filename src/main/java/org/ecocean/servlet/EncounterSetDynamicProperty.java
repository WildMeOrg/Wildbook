    ...
    throws ServletException, IOException {
        ...
        if ((request.getParameter("number") != null) && (request.getParameter("name") != null)) {
            ...
            try {
                if (newValue.equals("null")) {
                    ...
                    changeMe.addComments("<p><em>" + request.getRemoteUser() + " on " +
                        ...
                        "</em><br>Removed dynamic property <em>" + name +
                        "</em>. The old Value was <em>" + oldValue + ".</em></p>");
                } else {
                    changeMe.setDynamicProperty(name, newValue);
                    changeMe.addComments("<p><em>" + request.getRemoteUser() + " on " +
                        (new java.util.Date()).toString() + "</em><br>Set dynamic property <em>" +
                        name + "</em> from <em>" + oldValue + "</em> to <em>" + newValue +
                        "</em>.</p>");
                }
            } catch (Exception le) {
            ...
            if (!locked) {
                ...
                if (!newValue.equals("")) {
                    out.println("<strong>Success:</strong> Encounter dynamic property " + name +
                ...
                String message = "Encounter " + request.getParameter("number") +
                    " dynamic property " + name + " has been updated from \"" + oldValue +
                    "\" to \"" + newValue + "\".";
                ...
                out.println("<strong>Failure:</strong> Encounter dynamic property " + name +
            ...
            out.println("<p><a href=\"" + request.getScheme() + "://" +
                CommonConfiguration.getURLLocation(request) + "/encounters/encounter.jsp?number=" +
