...
public class LoginUserSocial extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
    ...
    throws ServletException, IOException {
        ...
        if ("facebook".equals(socialType)) {
            ...
            fbclient.setCallbackUrl(request.getScheme() + "://" +
                CommonConfiguration.getURLLocation(request) + "/LoginUserSocial?type=facebook");
            ...
            if (credentials != null) {
                ...
                try {
                    ...
                    System.out.println("getId() = " + facebookProfile.getId() + " -> user = " +
                        fbuser);
                    if (fbuser == null) {
            ...
            String callbackUrl = request.getScheme() + "://" +
                CommonConfiguration.getURLLocation(request) + "/LoginUserSocial?type=flickr";
            try {
