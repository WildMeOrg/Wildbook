     ...
     // enc.setPhotographerEmail(getVal(formValues, "photographerEmail"));
      ...
      enc.setDWCDateLastModified(strOutputDateTime);
        ...
        if (!AccessControl.isAnonymous(request)) {
            indiv = assignMarkedIndividual(myShepherd, enc, getVal(formValues, "indiv-id"));
...
/*  we can optionally add this back in below for giraffespotter -- it basically skips ID if the name was given
                if (indiv != null) {
