...
private final String UPLOAD_DIRECTORY = "/tmp";
  ...
  private List<MeasurementEvent> getMeasurementEvents(Map formValues, String encID, String context) {
...
*/
      ...
      List<MeasurementEvent> measurements = getMeasurementEvents(formValues, encID, context);
      ...
      enc.setDWCDateLastModified(strOutputDateTime);
        ...
        Task task = null; // we need this available to get an ID from for confirmSubmit redirect.
            ...
            if (!spamBot) {
                ...
                task = org.ecocean.ia.IA.intakeMediaAssets(myShepherd, enc.getMedia(), parentTask);  //TODO are they *really* persisted for another thread (queue)
