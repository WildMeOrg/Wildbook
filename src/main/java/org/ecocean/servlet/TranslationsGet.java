        ...
        try {
            ...
            if (Util.stringExists(propsName)) {
                ...
                if (props != null && !props.isEmpty()) {
                    ...
                    addErrorMessage(res,
                        "TranslationGet: No properties file named " + propsName +
                        " was found for langCode " + langCode +
                        ", or no properties were defined in it.");
                    response.setStatus(HttpServletResponse.SC_NO_CONTENT);
                }
            } else {
                addErrorMessage(res,
                    "TranslationGet: No name was provided for a properties file to get.");
                response.setStatus(HttpServletResponse.SC_NO_CONTENT);
            }
            if (out != null) {
            ...
            npe.printStackTrace();
            addErrorMessage(res,
                "TranslationGet: NullPointerException npe while getting translations.");
