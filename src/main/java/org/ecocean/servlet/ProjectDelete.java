...
public class ProjectDelete extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (projectIdPrefix != null && !"".equals(projectIdPrefix) &&
                myShepherd.getProjectByProjectIdPrefix(projectIdPrefix) != null) {
                ...
                for (Encounter enc : encounters) {
                    String comment = "<p><em>" + myShepherd.getUsername(request) + " on " +
                        ...
                        "removed this encounter from Project " + project.getResearchProjectName() +
                        "</p>";
