...
System.out.println("params.get(\"path\") -> " + params.get("path"));
      ...
      if ((myShepherd.isEncounter(encounterNumber))&&!locked) {
        ...
        if (!locked) {
          ...
          if ((action.equals("imageadd"))||(action.equals("imageadd2"))) {
            String link = ServletUtilities.getEncounterUrl(encounterNumber,request);
          ...
          /*
            ...
            response.sendRedirect(ServletUtilities.getEncounterUrl(encounterNumber, request));
          }
          */
          else {
            String link = ServletUtilities.getEncounterUrl(encounterNumber, request);
