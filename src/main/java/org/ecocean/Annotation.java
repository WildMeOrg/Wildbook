...
System.out.println("[1] getMatchingSet params=" + params);
    ...
    private String getMatchingSetFilterViewpointClause(Shepherd myShepherd) {
        ...
        if (viewpoints == null || (getSpecies(myShepherd)!=null && getSpecies(myShepherd).equals("Tursiops truncatus")) || (getSpecies(myShepherd)!=null && getSpecies(myShepherd).equals("Orcinus orca"))) return "";
