...
public class FingerPrint {
    /**
     * FingerPrint Protected and Private Variables Comments: Moving from a file based system to a database system, so all references to file based
...
// End change
    ...
    /**
     * This caculates the distance and distance score comparing a FingerPrint object to a visitor FingerPrint object passed as parameter f.
     *
     * @param f           FingerPrint : The visitor FingerPrint object that is passed.
     * @param pairs       HashMap : A passed reference key:value object map of distance:Pair values that are calculated.
     * @param affine_corr int : a known affine correction value (skew, shear, rotate, etc.).
     * @return double : Returns the calculated distance score (note, this is not the total distance between points) with a default value of 1000000.0
     * returned if the comparison did not succeed.
     */
    ...
    /**
     * Adds the distance and array index reference between two points in two different FingerPrints.
     *
    ...
    /**
     * Find the matching pair object with the same soure FingerPrint point index
     *
    ...
    /**
     * Finds the distance between a point in the local fpp[] array and that in a test FingerPrint class.
     *
    ...
    /**
     * Sets the total distance score for all the points in this class compared to another FingerPrint class passed in via the distance method.
     *
     * @param s
     */
    ...
    /* FingerPrint Private Methods Comments: None
     */
