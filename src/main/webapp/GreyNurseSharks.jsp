...
<div class="container maincontent">
	...
	<ol>
		<li>
			Environment Australia. (2002). Recovery plan for the Grey Nurse Shark (<em>Carcharias taurus</em>) in Australia, Environment Australia, June 2002. <a href="www.environment.gov.au/coasts/publications/grey-nurse-plan/">www.environment.gov.au/coasts/publications/grey-nurse-plan/</a>. [accessed 2008 June 12]
		</li>
		<li>
		...
		<li>
			Dicken, M, Booth, A, Smale M. (2006). Preliminary observations of tag shedding, tag reporting, tag wounds, and tag biofouling for raggedtooth sharks (<em>Carcharias taurus</em>) tagged off the east coast of South Africa. Journal of Marine Science. 63
		</li>
		<li>
			Van Tienhoven A, Den Hartog J, Reijns R, Peddemors VM. (2007) A computer-aided program for pattern-matching of natural marks on the spotted raggedtooth shark <em>Carcharias taurus</em>. Journal of Applied Ecology. 44: 272-280.
		</li>
		<li>
			Bansemer ,C, Bennet, M.B. (2008) Multi-year validation of photographic identification of grey nurse sharks, <em>Carcharias taurus</em>, and applications for non-invasive conservation research. Marine and Freshwater Research 59: 322-331
		</li>
		<li>
		...
		<li>
			Department of the Environment (2014) Recovery Plan for the Grey Nurse Shark (<em>Carcharias taurus</em>) in Australia. Commonwealth of Australia, Canberra. <a href="http://www.environment.gov.au">http://www.environment.gov.au</a> (accessed 2015 December 20)
		</li>
		<li>
			Otway, N. M., &amp; Ellis, M. T. (2011) Pop-up archival satellite tagging of <em>Carcharias taurus</em>: movements and depth/temperature-related use of SE Australian waters. Marine and Freshwater Research 62(6), pp. 607-620.
		</li>
		<li>
		...
		<li>
			Barker SM, Williamson JE. 2010. Collaborative photo-identification and monitoring of Grey Nurse Sharks (<em>Carcharias taurus</em>) at key aggregation sites along the eastern coast of
			Australia. Mar Freshw Res. 61:971-979.
		</li>
		<li>
			Pollard D, Lincoln-Smith MP, Smith AK. 1996. The biology and conservation status of the Grey Nurse Shark (<em>Carcharias taurus</em>, Rafinesque 1810) in NSW, Australia. Aqua
