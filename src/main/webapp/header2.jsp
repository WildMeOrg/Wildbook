...
/* If you can see the pattern in the above IE5.5 and IE6 style then you can add as many sub levels as you like */
	...
	<div id="header">
	<a href="http://www.whaleshark.org/adoptashark.jsp"><img name="masthead" src="http://<%=CommonConfiguration.getURLLocation(request) %>/images/masthead_dark3.png" width="810" height="150" border="0"></a>
