...
<tr>
  <td>
    ...
    <h4 class="intro" style="background-color: #cccccc; padding:3px; border: 1px solid #000066; "><a
      ...
      src="../images/Black_Arrow_down.png" width="14" height="14" border="0" align="absmiddle"/>
      <font color="#000000"><%=props.getProperty("patternRecognition") %></font></a></h4>
  </td>
</tr>
<tr>
  <td>
    <div id="patternrecognition" style="display:none; ">
      ...
      <table width="720px" align="left">
        <tr>
          <td>
            <label><input name="hasSpots" type="checkbox" id="hasSpots" value="hasSpots">&nbsp;<%=props.getProperty("hasPattern") %></label>
          </td>
        </tr>
        <tr>
          <td>
            <label><input name="hasNoSpots" type="checkbox" id="hasNoSpots" value="hasNoSpots">&nbsp;<%=props.getProperty("hasNoPattern") %></label>
          </td>
        </tr>
      </table>
   </div>
