...
%>
	...
	%>	
		<p><strong><%=props.getProperty("correspondingSurvey") %></strong>: <a href="//<%=CommonConfiguration.getURLLocation(request)%>/surveys/survey.jsp?occID=<%=occ.getPrimaryKeyID()%>"><%=surveyID%></a></p>
		<br/>  				
	<%	
	} else {
	%>	
