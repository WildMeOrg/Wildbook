...
<div class="container maincontent">
  <table border="0">
    <tr>
      <form id="adoption-form" style="display:none;" action="AdoptionAction" method="post" enctype="multipart/form-data" name="adoption_submission" target="_self" dir="ltr">
                    ...
                    <div class="input-col-1">
                            <div class="input-group">
                              ...
                              <input id="sharkId" class=" input-m-width" name="shark" type="text" value="shark" placeholder="Browse the gallery and find the shark that suit$
