...
//setup our Properties object to hold all properties
	...
	props=ShepherdProperties.getProperties("whoweare.properties", langCode, context);
        ...
        request.setAttribute("pageTitle", "Kitizen Science &gt; Second Trial has ended");
%>
...
<%= NoteField.buildHtmlDiv("3c1895fa-dd78-4088-9d76-52bbc252921d", request, myShepherd) %>
<div class="org-ecocean-notefield-default" id="default-3c1895fa-dd78-4088-9d76-52bbc252921d">
    <p>
    Our second validation trial is now complete.
    </p>
</div>
