<%@ page contentType="text/html; charset=utf-8" language="java"
         import="org.ecocean.shepherd.core.*,org.ecocean.servlet.ServletUtilities,org.ecocean.*, javax.jdo.Extent, javax.jdo.Query, java.util.ArrayList, java.util.List, java.util.GregorianCalendar, java.util.Iterator, java.util.Properties, java.io.IOException" %>
...
//let's load out properties
  ...
  // dsProps = ShepherdProperties.getProperties("studySite.properties", langCode,context);
...
<p>
<%
String titleString=dsProps.getProperty("StudySiteSearch");
String formAction="studySiteSearchResults.jsp";
%>
    ...
    <td>
        <div id="tags" style="display:none;">
            ...
            %>
              ...
              <%
              for (String fieldName : StudySiteQueryProcessor.SIMPLE_STRING_FIELDS) {
