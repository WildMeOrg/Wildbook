	 			...
	 			if((locProps.getProperty(locID)!=null)&&(locProps.getProperty(locID).indexOf(",")!=-1)){
	 		        ...
	 		        if(numSightings>0){
			          ...
			          bounds.extend(latLng<%=i%>);
	 		          ...
	 		          var divString<%=i%> = "<div style=\"font-weight:bold;text-align: center;line-height: 45px;vertical-align: middle;width:60px;height:29px;padding: 2px; background-image: url('cust/mantamatcher/img/gsb_map.marker.png');background-size: cover\"><a href=\"encounters/searchResults.jsp?locationCodeField=<%=locID %>\"><%=numSightingsInteger.toString() %></a></div>";
    ...
    <section class="container text-center  main-section">
        ...
        <main class="container">
            <article class="text-center">
                <div class="row">
                    <img src="cust/mantamatcher/img/bass/danHardingQuote.png" alt="" class="pull-left col-xs-7 col-sm-4 col-md-4 col-lg-4 col-xs-offset-2 col-sm-offset-1 col-md-offset-1 col-lg-offset-1" />
