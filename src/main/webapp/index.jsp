    ...
    <div class="container relative">
        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
            <div id="index-splash-text">
                ...
                <h1 class="hidden">Wildbook for Deer</h1>
                <!--<h2>Wildbook for Deer</h2>-->
                <a href="submit.jsp">
                    ...
                    <ul class="encounter-list list-unstyled">
                       ...
                       try{
	                       for(int i=0;i<numResults;i++){
	                           ...
	                           %>
	                            <li>
	                                <img src="cust/mantamatcher/img/deer.png" alt="" width="85px" height="75px" class="pull-left" />
	                                <small>
	                                    <time>
	                                        <%=thisEnc.getDate() %>
	                                        <%
