                        ...
                        <ul class="dropdown-menu" role="menu">
                          ...
                          <li class="dropdown"><a href="<%=urlLoc %>/overview.jsp"><%=props.getProperty("aboutWildbook")%></a></li>
                            ...
                            <li class="dropdown-submenu">
                              <a class="d-flex align-items-center justify-space-between" tabindex="-1" href="<%=urlLoc %>/react/policies-and-data?section=citing_wildbook"><%=props.getProperty("policiesAndData")%></a></li> --%>
