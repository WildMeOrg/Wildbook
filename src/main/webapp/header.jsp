...
<html>
    ...
    <style>
        .el-search {
            color: #888;  /* for white background of giraffespotter */
        }
      ul.nav.navbar-nav {
        width: 100%;
      }
                  ...
                  %>
                    ...
                    <ul class="secondary-nav hor-ul no-bullets">
                      ...
                      <%
                          ...
                          <li><a style="color:black;" href="<%= request.getContextPath() %>/react/login/" title=""><%= props.getProperty("login") %></a></li>
	                      <%
	                      }
                    ...
                    <ul class="nav navbar-nav">
                      ...
                      <!-- start locationID sites -->
                       <li class="dropdown">
                        ...
                        <%=org.ecocean.LocationID.getBootstrapMenu(null, urlLoc)%>
                      </li>
