<%@ page contentType="text/html; charset=utf-8" language="java"
         import="org.ecocean.servlet.ServletUtilities,org.ecocean.*,org.ecocean.datacollection.*, javax.jdo.Extent, javax.jdo.Query, java.util.ArrayList, java.util.List, java.util.GregorianCalendar, java.util.Iterator, java.util.Properties, java.io.IOException" %>
...
//let's load out properties
  ...
  // dsProps = ShepherdProperties.getProperties("dataSheet.properties", langCode,context);
...
<p>
<%
String titleString=dsProps.getProperty("DataSheetSearch");
String formAction="dataSheetSearchResults.jsp";
%>
...
%>
<p><em><strong><%=dsProps.getProperty("searchInstructions")%>
</strong></em></p>
...
<!--  date of birth and death -->
      <p><strong><%=dsProps.getProperty("dateStart")+" "+dsProps.getProperty("range")%>:</strong></p>
      <table>
      	<tr>
      		<td><%=dsProps.getProperty("start") %> <input type="text" id="eventStartDate-From" name="eventStartDate-From" class="addDatePicker"/></td>
      		<td><%=dsProps.getProperty("end") %> <input type="text" id="eventStartDate-To" name="eventStartDate-To" class="addDatePicker"/></td>
      	</tr>
      </table>

      <p><strong><%=dsProps.getProperty("dateEnd")+" "+dsProps.getProperty("range")%>:</strong></p>
      <table>
      	<tr>
      		<td><%=dsProps.getProperty("start") %> <input type="text" id="eventEndDate-From" name="eventEndDate-From" class="addDatePicker"/></td>
      		<td><%=dsProps.getProperty("end") %> <input type="text" id="eventEndDate-To" name="eventEndDate-To" class="addDatePicker"/></td>
      	</tr>
      </table>
  ...
  <tr id="FieldsTitleRow">
    <td>
      <h4 class="intro" style="background-color: #cccccc; padding:3px; border: 1px solid #000066; "><a
        ...
        src="images/Black_Arrow_down.png" width="14" height="14" border="0" align="absmiddle"/> <font
        color="#000000"><%=dsProps.getProperty("fieldsTitle") %></font></a></h4>
    </td>
  </tr>
  ...
  <tr id="fieldsContentRow">
    <td>
        <div id="tags" style="display:none;">
            <p><%=dsProps.getProperty("fieldsInstructions") %></p>
            ...
            %>
              ...
              <%
              for (String fieldName : DataSheetQueryProcessor.SIMPLE_STRING_FIELDS) {
                printStringFieldSearchRow(fieldName, out, dsProps);
              }
              %>
              </table>
              </table>
