...
<table border="1" bordercolor="black" cellspacing="0">
	<tr><td bgcolor="#CCCCCC"><strong>Complete Tabular Export of Individual Records</strong></td></tr>
	<tr><td bgcolor="#FFFFFF"><a href="//<%=CommonConfiguration.getURLLocation(request)%>/IndividualSearchExportAllData?<%=queryString%>">
		Click here</a>
        </td></tr>
</table>
	</p>
