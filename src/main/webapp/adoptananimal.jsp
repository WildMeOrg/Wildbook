...
<div class="container maincontent adoption-page">
	...
	<h2>Support cutting edge lynx research.</h2>
	<section class="adoption-details">
		<p>
			Adopt a lynx, give it a nickname, and receive updates each time it's spotted! Funds
	...
	<%-- <section class="donations">
		<article class="donation-option-group">
			...
			<div class="donation-option">
				...
				<p>
					We appreciate your support of ongoing lynx research
				</p>
			</div>
		</article>
	</section> --%>
