<%@ page contentType="text/html; charset=utf-8" language="java"
         import="org.joda.time.format.DateTimeFormat,
                 ...
                 org.ecocean.servlet.ServletUtilities,
                 org.ecocean.Util,
                 org.ecocean.Measurement,
                 org.ecocean.Util.*,
                 org.ecocean.genetics.*,
                 org.ecocean.tag.*,
                 java.awt.Dimension,
                 org.json.JSONObject,
                 org.json.JSONArray,
...
<div class="container maincontent">
    ...
    <div class="row" id="mainHeader">
            ...
            <%
                ...
                if (myShepherd.isEncounter(num)) {
                    try {
                        ...
                        if (isAdmin && (setState != null) && (setState.equals("processing") || setState.equals("validation") || setState.equals("finished") || setState.equals("pending") || setState.equals("mergereview") || setState.equals("disputed"))) {
                ...
                function flag(type, action = 1) {
                    ...
                    $.ajax({
                        ...
                        data: JSON.stringify({
                            action: action,
                            property: 'flag',
                            value: {value: ['flag-' + type], via: 'encounter.jsp'},
      ...
      %>
            ...
            <% String dup = enc.getDynamicPropertyValue("duplicateOf");
                if (dup != null) { %>
            <div style="display: inline-block; padding: 1px 5px; background-color: #AAA; color: #833; border-radius: 4px;">
                This encounter is marked as a <b>duplicate of <a href="encounter.jsp?number=<%=dup%>"><%=dup%>
            </a></b>.
            </div>
            <% } %>

            <p class="caption"><em><%=encprops.getProperty("description") %>
            </em></p>
                ...
                <tr valign="middle">
                    ...
                    <td>
                        ...
                        <div class="fb-share-button"
                             data-href="//<%=CommonConfiguration.getURLLocation(request) %>/encounters/encounter.jsp?number=<%=request.getParameter("number") %>"
...
*/
                    ...
                    for (Decision dec : decs) {
                        ...
                        if (decMap.get(dec.getProperty()) == null)
                            decMap.put(dec.getProperty(), new HashMap<String, Integer>());
                        String propVal = val.optString("value", null);
                        if (propVal == null) continue;
                        if (decMap.get(dec.getProperty()).get(propVal) == null)
                            decMap.get(dec.getProperty()).put(propVal, 0);
            ...
            <div id="kitsci-meta">
                <div class="kitsci-volunteer">
                    ...
                    <p style="color: #888;">total volunteer decisions: <b><%=countDec%>
                    </b></p>
                        ...
                        <%
                            if (countFlag < 1) {
                                ...
                                for (String val : flagMap.keySet()) {
                                    ...
                                    if (val.equals("flag-locationid-missing"))
                                        ct = 1; //because a new one gets added each time queue.jsp is run, let's not inflate the count beyond one -Mark F.
                                    String pct = "";
                                    double p = new Double(ct) / new Double(countFlag);
                                    if (ct < countFlag) pct = Math.round(p * 100d) + "%";
                                    out.println("<div style=\"opacity: " + (0.25d + (p * 0.75d)) + "\" class=\"prop-val\"><span class=\"prop-val-val\">" + val.substring(5) + "</span> <b class=\"prop-val-ct\">" + ct + "</b> <a href=\"javascript:flag('" + val + "',0);\">X</a>  <span class=\"prop-val-pct\">" + pct + "</span></div>");
                                }
                            }
                        %>
                    </div>
                ...
                <div class="kitsci-attributes">
                    ...
                    <div class="kitsci-attribute">
                        Color/Pattern: <b><%=enc.getPatterningCode()%>
                    </b>
                    </div>
                    <div class="kitsci-attribute">
                        Sex: <b><%=enc.getSex()%>
                    ...
                    <div class="kitsci-attribute">
                        Collar: <b><%=enc.getCollar()%>
                    </b>
                    </div>
                    <div class="kitsci-attribute">
                        Life stage: <b><%=enc.getLifeStage()%>
                    </b>
                    </div>
                    <div class="kitsci-attribute">
                        Ear tip: <b><%=enc.getEarTip()%>
                    </b>
                    </div>
                    <div class="kitsci-attribute">
                        Behavior: <b><%=((enc.getBehavior() == null) ? "-" : enc.getBehavior())%>
                    </b>
                    </div>
                </div>

                <div class="kitsci-actions">
                    <h2>Current state: <b><%=enc.getState()%>
                    </b></h2>
                    <button class="button-smaller"
                            onclick="return flag('detection-multicat-fail');"><%= encprops.getProperty("multiCatDetFailFlag") %>
                    </button>
                    <button class="button-smaller"
                            onclick="return flag('detection-multicat-false');"><%= encprops.getProperty("multiCatFalseFlag") %>
                    </button>
                    <button class="button-smaller"
                            onclick="return flag('detection-fail');"><%= encprops.getProperty("flagDetFail") %>
                    </button>
                    <button class="button-smaller"
                            onclick="return flag('detection-box-redraw');"><%= encprops.getProperty("flagBoxRedraw") %>
                    </button>
                    <button class="button-smaller"
            ...
            <div class="admin-only col-xs-12 col-sm-6" style="vertical-align: top;padding-left: 10px;">
                ...
                <h2>
                    ...
                    <button class="btn btn-md" type="button" name="button" id="closeEditLocation" style="display:none;">
                        Close Edit
                    </button>
                </h2>
                ...
                %>
                <h2>
                    <img src="../images/2globe_128.gif" width="40px" height="40px"
                         align="absmiddle"/> <%=encprops.getProperty("location") %>
                </h2>
                ...
                <em><%=encprops.getProperty("locationDescription")%> <span
                        id="displayLocation"><%=enc.getLocation()%></span></em>
                <%
                    }
                %>
                ...
                </em><span> <span id="displayLocationID"><%=enc.getLocationCode()%></span></span>
                ...
                <a href="<%=CommonConfiguration.getWikiLocation(context)%>country" target="_blank"><img
                        src="../images/information_icon_svg.gif" alt="Help" border="0" align="absmiddle"></a>
                <em><%=encprops.getProperty("country") %>
                </em>
                <%
                ...
                <div>
                    ...
                    <p class="editTextLocation"><strong><%=encprops.getProperty("setLocation")%>
                    </strong></p>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5">
                                <textarea name="location" class="form-control"
                                          id="locationInput"><%=thisLocation%></textarea>
                            </div>
                            <div class="col-sm-3">
                                <input name="Add" type="submit" id="addLocation"
                                       value="<%=encprops.getProperty("setLocation")%>" class="btn btn-sm"/>
                ...
                <div>
                    ...
                    <p class="editTextLocation"><strong><%=encprops.getProperty("resetCountry")%>
                    </strong></p>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5">
                                <select name="country" id="selectCountry" size="1" class="form-control">
                                    ...
                                    %>
                                    <option value="<%=obj.getDisplayCountry() %>"><%=obj.getDisplayCountry() %>
                                    </option>
                            ...
                            <div class="col-sm-3">
                                <input name="<%=encprops.getProperty("set")%>" type="submit" id="countryFormBtn"
                                       value="<%=encprops.getProperty("set")%>" class="btn btn-sm editFormBtn"/>
                ...
                <div>
                    ...
                    <p class="editTextLocation"><strong><%=encprops.getProperty("setLocationID")%>
                    </strong></p>
                    <form name="addLocCode" class="editFormLocation">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input name="Set Location ID" type="submit" id="setLocationBtn"
                                       value="<%=encprops.getProperty("setLocationID")%>" class="btn btn-sm"/>
                            </div>
                        </div>
                        <%
                        } else {
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5">
                                <select name="code" id="selectCode" class="form-control" size=="1">
                                    ...
                                    %>
                                    <option <%=selected %>
                                            value="<%=CommonConfiguration.getProperty(currentLoc,context)%>"><%=CommonConfiguration.getProperty(currentLoc, context)%>
                                    </option>
                                    <%
                                                codeTaxNum++;
                                            } else {
                ...
                <div>
                    ...
                    <p class="editTextLocation"><strong><%=encprops.getProperty("setDepth")%>
                    </strong></p>
                    <form name="setencdepth" class="editFormLocation">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5" id="depthDiv">
                                <input name="depth" type="text" id="depthInput"
                                       class="form-control"/><span><%=encprops.getProperty("meters")%></span>
                                <span class="form-control-feedback" id="depthCheck">&check;</span>
                                <span class="form-control-feedback" id="depthError">X</span>
                            </div>
                            <div class="col-sm-3">
                                <input name="AddDepth" type="submit" id="AddDepth"
                                       value="<%=encprops.getProperty("setDepth")%>" class="btn btn-sm editFormBtn"/>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                %>
                <br/>
                <em><%=encprops.getProperty("elevation") %>
                </em>
                &nbsp;
                <%
            ...
            %>
                ...
                <div>
                    ...
                    <p class="editTextLocation"><strong><%=encprops.getProperty("setElevation")%>
                    </strong></p>
                    <form name="setencelev" class="editFormLocation">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5" id="elevationDiv">
                                <input name="elevation" type="text" id="elevation"
                                       class="form-control"/><span><%=encprops.getProperty("meters")%></span>
                        ...
                        <input name="AddElev" type="submit" id="AddElev"
                               value="<%=encprops.getProperty("setElevation")%>" class="btn btn-sm editFormBtn"/>
                    </form>
                </div>
                <!-- end elevation  -->
                <%
 			...
 			%>
                ...
                <div>
                    ...
                    <form name="resetGPSform" class="editFormLocation">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <input name="setGPSbutton" type="submit" id="setGPSbutton"
                                       value="<%=encprops.getProperty("setGPS")%>" class="btn btn-sm"/>
                    ...
                    <br/>
                    <span class="editTextLocation"><%=encprops.getProperty("gpsConverter")%></span><a
                        class="editTextLocation" href="http://www.csgnetwork.com/gpscoordconv.html" target="_blank">Click
                ...
                <div style="background-color: #E8E8E8;padding-left: 10px;padding-right: 10px;padding-top: 10px;padding-bottom: 10px;">
                    ...
                    <% if (isOwner && CommonConfiguration.isCatalogEditable(context)) { %>
                    <h2><img align="absmiddle" src="../images/wild-me-logo-only-100-100.png" width="40px"
                             height="40px"/> <%=encprops.getProperty("identity") %>
                        <button class="btn btn-md" type="button" name="button" id="editIdentity">Edit</button>
                        <button class="btn btn-md" type="button" name="button" id="closeEditIdentity"
                                style="display:none;">Close Edit
                        </button>
                    </h2>
				...
				%>
                    ...
                    <div>
                        <p class="para">
                            ...
                            <a href="../individuals.jsp?langCode=<%=langCode%>&number=<%=enc.getIndividualID()%>">
                                <span id="displayIndividualID"><%=ServletUtilities.handleNullString(enc.getDisplayName())%></span></a>
                        </p>

                        <p>
                            <img align="absmiddle" src="../images/Crystal_Clear_app_matchedBy.gif">
                            <span><%=encprops.getProperty("matched_by") %>: <span
                                    id="displayMatchedBy"><%=enc.getMatchedBy()%></span></span>
                        </p>
                        ...
                        <form name="setMBT" class="editForm">
                            ...
                            <div class="form-group row" id="selectMatcher">
                                <div class="col-sm-3">
                                    <label><%=encprops.getProperty("matchedBy")%>
                                    </label>
                                </div>
                                <div class="col-sm-5 col-xs-10">
                                    <select name="matchedBy" id="matchedBy" size="1" class="form-control">
                                        <option value="Unmatched first encounter"><%=encprops.getProperty("unmatchedFirstEncounter")%>
                                        </option>
                                ...
                                <div class="col-sm-3">
                                    <input name="setMB" type="submit" id="setMB"
                                           value='<%=encprops.getProperty("set")%>' class="btn btn-sm editFormBtn"/>
                    ...
                    <div id="dialogIdentity" title="<%=encprops.getProperty("manageIdentity")%>" class="editForm">
                        ...
                        <div class="editText">
                            <h3><%=encprops.getProperty("manageIdentity")%>
                            </h3>
                            <p><em><small><%=encprops.getProperty("identityMessage") %>
                            </small></em></p>

                        </div>


                        <p class="add2shark"><strong><%=encprops.getProperty("add2MarkedIndividual")%>
                        </strong></p>
                        ...
                        <form name="add2shark" class="add2shark">
                            ...
                            <div class="form-group row" id="individualDiv">
                                <div class="col-sm-3">
                                    <label><%=encprops.getProperty("individual")%>
                                    </label>
                                </div>
                                <div class="col-sm-5 col-xs-10">
                                    <input name="individual" type="text" class="form-control"
                                           id="individualAddEncounterInput"/>
                                    ...
                                    <p style="font-size: smaller;"><em>Next suggested new ID: <a
                                            onclick="$('#individualAddEncounterInput').val('<%=nextID %>');$('#matchType').val('Unmatched first encounter').change();"><%=nextID  %>
                                    </a></em></p>
                            ...
                            <div class="form-group row" id="matchedByDiv">
                                ...
                                <div class="col-sm-5 col-xs-10">
                                    <select id="matchType" name="matchType" id="matchType" class="form-control"
                                            size="1">
                                        <option value="Unmatched first encounter"><%=encprops.getProperty("unmatchedFirstEncounter")%>
                                        </option>
                                        <option value="Visual inspection"><%=encprops.getProperty("visualInspection")%>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5 col-xs-10">
                                    <label><input name="noemail" type="checkbox"
                                                  value="noemail"/> <%=encprops.getProperty("suppressEmail")%>
                                    </label>
                                </div>
                            </div>
                            <input name="Add" type="submit" id="Add" value="<%=encprops.getProperty("add")%>"
                                   class="btn btn-sm editFormBtn add2shark"/>
                        </form>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 col-xs-10">
                                    <label id="removeLabel"
                                           class="highlight"><strong><%=encprops.getProperty("removeFromMarkedIndividual")%>
                                    </strong></label>
                                    <input name="number" type="hidden" value="<%=num%>"
                                           id="individualRemoveEncounterNumber"/>
                                    <input name="action" type="hidden" value="remove"/>
                                    <input type="submit" name="Submit" value="<%=encprops.getProperty("remove")%>"
                                           id="individualRemoveEncounterBtn" class="btn btn-sm editFormBtn"/>
                                </div>
                            </div>
                        </form>
                        <br>
                    ...
                    <form name="setAltID" class="editForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5 col-xs-10" id="altIdDiv">
                                <input name="alternateid" id="alternateid" type="text" class="form-control"
                                       placeholder="<%=encprops.getProperty("alternate_id")%>"/>
                                <span class="form-control-feedback" id="altIdCheck">&check;</span>
                                <span class="form-control-feedback" id="altIdError">X</span>
                            </div>
                            <div class="col-sm-4">
                                <input name="Set" type="submit" id="setAltIDbtn"
                                       value="<%=encprops.getProperty("set")%>" class="btn btn-sm editFormBtn"/>
                            </div>
                        </div>
                    </form>
                    ...
                    <p class="para">
                        ...
                        %>
                        <a href="../occurrence.jsp?number=<%=myShepherd.getOccurrenceForEncounter(enc.getCatalogNumber()).getOccurrenceID() %>"><span
                    ...
                    <div class="editText" id="occurrenceEditMessage">
                        <h3><%=encprops.getProperty("assignOccurrence")%>
                        </h3>
                        <p class="editText"><em><small><%=encprops.getProperty("occurrenceMessage")%>
                        </small></em></p>
                    </div>
                    ...
                    <form class="editForm" name="removeOccurrence">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label id="removeOccurLabel"
                                       class="highlight"><strong><%=encprops.getProperty("removeFromOccurrence")%>
                                </strong></label>
                                <input type="submit" name="Submit" value="<%=encprops.getProperty("remove")%>"
                                       id="removeOccurrenceBtn" class="btn btn-sm editFormBtn"/>
                            </div>
                        </div>
                    </form>
                    ...
                    <form name="createOccurrence" class="editForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5 col-xs-10" id="occurDiv">
                                <input name="occurrence" type="text" id="createOccurrenceInput" class="form-control"
                            ...
                            <div class="col-sm-4">
                                <input name="Create" type="submit" id="createOccur"
                                       value="<%=encprops.getProperty("create")%>" class="btn btn-sm editFormBtn"/>
                            </div>
                        </div>
                    </form>
                    ...
                    <form name="add2occurrence" class="editForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5 col-xs-10" id="addDiv">
                                <input name="occurrence" id="add2OccurrenceInput" type="text" class="form-control"
                                       placeholder="<%=encprops.getProperty("occurrenceID")%>"/>
                            ...
                            <div class="col-sm-4">
                                <input name="Add" type="submit" id="addOccurrence"
                                       value="<%=encprops.getProperty("add")%>" class="btn btn-sm editFormBtn"/>
                            </div>
                        </div>
                    </form>
                ...
                <div>
                    ...
                    <% if (isOwner && CommonConfiguration.isCatalogEditable(context)) { %>
                    <h2>
                        <img align="absmiddle" src="../images/Crystal_Clear_kuser2.png" width="40px"
                             height="42px"/> <%=encprops.getProperty("contactInformation") %>
                        <button class="btn btn-md" type="button" name="button" id="editContactBtn">Edit</button>
                        <button class="btn btn-md" type="button" name="button" id="closeEditContact"
                                style="display:none;">Close Edit
                        </button>
                    </h2>
                    ...
                    <% } else {
                    %>
                    <h2><img align="absmiddle" src="../images/Crystal_Clear_kuser2.png" width="40px"
                             height="42px"/> <%=encprops.getProperty("contactInformation") %>
                    </h2>
                    ...
                    <p class="para"><h4><%=encprops.getProperty("submitter") %>
                </h4>
                    <%
                    ...
                    <table id="submitters" width="100%">
                        ...
                        <tr id="<%=user.getUUID() %>">
                            <td>
                                ...
                                <p style="background-color: #B0C4DE;border-radius:5px;padding: 5px;"
                                   id="<%=user.getUUID() %>">
                                    ...
                                    %>
                                    <br/><a
                                        href="mailto:<%=user.getEmailAddress()%>?subject=<%=encprops.getProperty("contactEmailMessageHeading") %><%=enc.getCatalogNumber()%>:<%=CommonConfiguration.getProperty("htmlTitle",context)%>"><%=user.getEmailAddress()%>
                                </a>
                                    <%
                                        }
                            ...
                            <td style="display: table;vertical-align:middle;">
                                ...
                                &nbsp;<button id="remove<%=user.getUUID() %>button" class="btn btn-sm editUsers"
                                              style="margin-top:0;display: inline-block;"
                                              type="submit"><%=encprops.getProperty("remove") %>
                            </button>
                            </div>
                                <%
                                    }
                    ...
                    <div name="addUser" class="editFormUsers editUsers">
                        <input type="hidden" name="encounter" value="<%=enc.getCatalogNumber() %>"/>
                        <input type="hidden" name="type" value="submitter"/>
                        <%=encprops.getProperty("addSubmitter") %> <input class="btn btn-sm addUser" name="email"
                                                                          id="addSubmitter" type="text"></input>&nbsp;<button
                            class="btn btn-sm addUser" style="margin-top:0;display: inline-block;"
                            type="submit"><%=encprops.getProperty("add") %>
                    </button>
                    </div>
                    <%
                        }
                    ...
                    <p class="para declutter"><h4 class="declutter"><%=encprops.getProperty("photographer") %>
                </h4>
                    <%
                    ...
                    <div name="addUser" class="editFormUsers editUsers">
                        <input type="hidden" name="encounter" value="<%=enc.getCatalogNumber() %>"/>
                        <input type="hidden" name="type" value="photographer"/>
                        <%=encprops.getProperty("addPhotographer") %> <input class="btn btn-sm addUser" name="email"
                                                                             id="addPhotographer" type="text"></input>&nbsp;<button
                            class="btn btn-sm addUser" style="margin-top:0;display: inline-block;"
                            type="submit"><%=encprops.getProperty("add") %>
                    </button>
                    </div>
                    ...
                    <p class="para declutter"><h4 class="declutter"><%=encprops.getProperty("inform_others") %>
                </h4> <%
                ...
                %>
                    ...
                    <div name="addUser" class="editFormUsers editUsers">
                        <input type="hidden" name="encounter" value="<%=enc.getCatalogNumber() %>"/>
                        <input type="hidden" name="type" value="informOther"/>
                        <%=encprops.getProperty("addOthers") %> <input class="btn btn-sm addUser" name="email"
                                                                       id="addOther" type="text"></input>&nbsp;<button
                            class="btn btn-sm addUser" style="margin-top:0;display: inline-block;"
                            type="submit"><%=encprops.getProperty("add") %>
                    </button>
                    </div>
                ...
                <table>
                    <tr>
                        <td width="560px"
                            style="vertical-align:top; background-color: #E8E8E8;padding-left: 10px;padding-right: 10px;padding-top: 10px;padding-bottom: 10px;">

                            <% if (isOwner && CommonConfiguration.isCatalogEditable(context)) { %>
                            <h2>
                                <img align="absmiddle" width="40px" height="40px" style="border-style: none;"
                                     src="../images/workflow_icon.gif"/> <%=encprops.getProperty("metadata") %>
                                <button class="btn btn-md" type="button" name="button" id="editMeta">Edit</button>
                                <button class="btn btn-md" type="button" name="button" id="closeEditMeta"
                                        style="display:none;">Close Edit
                                </button>
                            </h2>
                            ...
                            <% } else {
                            %>
                            <h2><img align="absmiddle" width="40px" height="40px" style="border-style: none;"
                                     src="../images/workflow_icon.gif"/> <%=encprops.getProperty("metadata") %>
                            </h2>
                            ...
                            <div>
                                ...
                                <p class="editTextMeta"><strong><%=encprops.getProperty("setWorkflowState")%>
                                </strong></p>
                                ...
                                <form name="workflowStateForm" class="editFormMeta">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <select name="state" id="selectState" class="form-control" size="1">
                                                <%
                                                    ...
                                                    while (hasMoreStates) {
                                                        ...
                                                        if (CommonConfiguration.getProperty(currentLifeState, context) != null) {
                                                %>
                                                <option value="<%=CommonConfiguration.getProperty(currentLifeState,context)%>"><%=CommonConfiguration.getProperty(currentLifeState, context)%>
                                                </option>
                                                <%
                                                            stateTaxNum++;
                                                        } else {
                                        ...
                                        <div class="col-sm-3">
                                            <input name="<%=encprops.getProperty("set")%>" type="submit" id="editWork"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="col-sm-6" style="padding-top: 15px; padding-bottom: 15px;">
                                                    <img src="../cust/mantamatcher/img/individual_placeholder_image.jpg"
                                                         class="lazyload" align="top" data-src="<%=profilePhotoURL%>"
                                                ...
                                                <div class="col-sm-6" style="padding-top: 15px; padding-bottom: 15px;">
                                                    ...
                                                    <p><strong><%=encprops.getProperty("affiliation") %>
                                                    </strong> <%=thisUser.getAffiliation() %>
                                                    </p>
                                                    <%
                                                        }
                                                    ...
                                                    %>
                                                    <p><strong><%=encprops.getProperty("researchProject") %>
                                                    </strong> <%=thisUser.getUserProject() %>
                                                    </p>
                                                    <%
                                                        }
                                                    ...
                                                    %>
                                                    <p><strong><%=encprops.getProperty("webSite") %>
                                                    </strong> <a style="font-weight:normal;color: blue" class="ecocean"
                                                                 href="<%=thisUser.getUserURL()%>"><%=thisUser.getUserURL() %>
                                                    </a></p>
                                                    <%
                                                        }
                                        ...
                                        <div>
                                            ...
                                            <p class="editTextMeta"><strong><%=encprops.getProperty("assignUser")%>
                                            </strong></p>
                                            ...
                                            <form name="asetSubmID" action="../EncounterSetSubmitterID" method="post"
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-5">
                                                        <select name="submitter" id="submitterSelect"
                                                            ...
                                                            %>
                                                            <option value="<%=thisUsername%>"><%=thisUserFullname%>
                                                            </option>
                                                            <%
                                                                }
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input name="Assign" type="submit" id="Assign"
                                ...
                                <form name="setTapirLink" class="editFormMeta">
                                    ...
                                    <%
                                        ...
                                        if (enc.getOKExposeViaTapirLink()) {
                                            tapirCheckIcon = "check_green.png";
                                        }
                                    %>
                                    <label>TapirLink:</label>&nbsp;
                                    <input style="width: 40px;height: 40px;" align="absmiddle" name="approve"
                                           type="image" src="../images/<%=tapirCheckIcon %>" id="tapirApprove"
                                           value="<%=encprops.getProperty("change")%>"/>
                                    &nbsp;
                                    <a href="<%=CommonConfiguration.getWikiLocation(context)%>tapirlink"
                                       target="_blank"><img src="../images/information_icon_svg.gif" alt="Help"
                            ...
                            <div>
                                <p><strong><%=encprops.getProperty("auto_comments")%>
                                </strong></p>
                                <div class="highlight resultMessageDiv" id="autoCommentErrorDiv"></div>
                                <%
                                    String rComments = "";
                                    if (enc.getRComments() != null) {
                                        rComments = enc.getRComments();
                                    }
                                %>

                                <div id="autoCommentsDiv"
                                     style="text-align:left;border: 1px solid lightgray;width:auto;height: 200px;overflow-y:scroll;overflow-x:scroll;background-color: white;padding-left: 10px;padding-right: 10px;">
                                ...
                                <form name="addComments" class="editFormMeta">
                                    <input name="user" type="hidden" value="<%=request.getRemoteUser()%>"
                                           id="autoUser"/>
                                    <input name="number" type="hidden" value="<%=enc.getEncounterNumber()%>"
                                           id="autoNumber"/>
                                    <input name="action" type="hidden" value="enc_comments" id="autoAction"/>

                                    <textarea name="autocomments" cols="50" id="autoComments"
                                              class="form-control"></textarea>
                                    <input name="Submit" type="submit" value="<%=encprops.getProperty("add_comment")%>"
                                           class="btn btn-sm" id="manualAdd"/>
                            ...
                            <table width="100%" border="0" cellpadding="1">
                                <tr>
                                    <td height="30" class="para">
                                        <form onsubmit="return confirm('<%=encprops.getProperty("sureDelete") %>');"
                                              name="deleteEncounter" class="editFormMeta" method="post"
                                              action="../EncounterDelete">
                                            <input name="number" type="hidden" value="<%=num%>"/>
                                            <%
                                                String deleteIcon = "cancel.gif";
                                            %>
                                            <input align="absmiddle" name="approve" type="submit"
                                                   class="btn btn-sm btn-block deleteEncounterBtn" id="deleteButton"
                                                   value="<%=encprops.getProperty("deleteEncounter") %>"/>
                                        </form>
                                    </td>
                                </tr>
                            </table>
                ...
                <c:if test="${showMeasurements}">
                    ...
                    <div class="declutter">
                        <h2>
                            ...
                            <button class="btn btn-md" type="button" name="button" id="closeEditMeasure"
                                    style="display:none;">Close Edit
                            </button>
                        </h2>
                        ...
                        <table>
                            <tr>
                                ...
                                <c:if test="${!empty samplingProtocols}">
                                    <th class="measurement">
                                        <display
                                                id="displayMsample"><%=encprops.getProperty("samplingProtocol") %></span>
                                    </th>
                                </c:if>
                            </tr>
                        ...
                        <div>
                            <p class="editTextMeasure"><strong><%=encprops.getProperty("setMeasurements")%>
                            </strong></p>
                            ...
                            <table cellpadding="1" cellspacing="0" bordercolor="#FFFFFF" class="editFormMeasure">
                                <form name="setMeasurements" class="editFormMeasure" id="measurementForm"
                                      action="../EncounterSetMeasurements" method="post">
        ...
        %>
          ...
          %>
                                    <tr>
                                        <td class="form_label">
                                            <c:out value="${item.label}"/>
                                            <input type="hidden" name="measurement${index}(id)"
                                                   value="${measurementEvent.dataCollectionEventID}"/>
                                        </td>
                                        <td>
                                            <input name="measurement${index}(value)" value="${measurementEvent.value}"
                                                   id="measurementEvent${index}"/>
                                            <input type="hidden" name="measurement${index}(type)" value="${item.type}"/>
                                            <input type="hidden" name="measurement${index}(units)"
                                                   value="${item.unitsLabel}"/>
                                            <c:out value="(${item.unitsLabel})"/>
                                                ...
                                                <c:forEach items="${optionDescs}" var="optionDesc">
                                                    <c:choose>
                                                        <c:when test="${measurementEvent.samplingProtocol eq optionDesc.name}">
                                                            <option value="${optionDesc.name}" selected="selected">
                                                                <c:out value="${optionDesc.display}"/></option>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <option value="${optionDesc.name}"><c:out
                                                                    value="${optionDesc.display}"/></option>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </c:forEach>
                                            </select>
                                    ...
                                    <tr>
                                        <td>
                                            <input name="${set}" type="submit" value="${set}"
                                                   class="btn btn-sm editFormBtn" id="addMeasurements"/>
                                        </td>
                                    </tr>
                            </table>
                            </form>
                ...
                <table class="declutter">
                    <tr>
                        <td width="560px"
                            style="vertical-align:top;background-color: #E8E8E8;padding-left: 10px;padding-right: 10px;">
                            ...
                            <c:if test="${showMetalTags}">
                                ...
                                <% if (isOwner && CommonConfiguration.isCatalogEditable(context)) { %>
                                <h2>
                                    <img align="absmiddle" src="../images/Crystal_Clear_app_starthere.png" width="40px"
                                         height="40px"/> <%=encprops.getProperty("tracking") %>
                                    <button class="btn btn-md" type="button" name="button" id="editTracking">Edit
                                    </button>
                                    <button class="btn btn-md" type="button" name="button" id="closeEditTracking"
                                            style="display:none;">Close Edit
                                    </button>
                                </h2>
                                ...
                                <% } else {
                                %>
                                <h2><img align="absmiddle" src="../images/Crystal_Clear_app_starthere.png" width="40px"
                                         height="40px"/> <%=encprops.getProperty("tracking") %>
                                </h2>
                                ...
                                <table>
                                    <c:forEach var="item" items="${metalTags}">
                                        ...
                                        %>
                                        <tr>
                                            <td><c:out value="${locationLabel}:"/></td>
                                ...
                                <div>
                                    <p class="editTextTracking"><strong><%=encprops.getProperty("resetMetalTags")%>
                                    </strong></p>
                                    <% pageContext.setAttribute("metalTagDescs", Util.findMetalTagDescs(langCode, context)); %>

                                    <form name="setMetalTags" class="editFormTracking" id="tagsForm"
                                          action="../EncounterSetTags" method="post">
                                        ...
                                        <table cellpadding="1" cellspacing="0">
                                            ...
                                            <c:forEach items="${metalTagDescs}" var="metalTagDesc">
                                                ...
                                                %>
                                                <tr>
                                                    <td class="formLabel"><c:out
                                                            value="${metalTagDesc.locationLabel}"/></td>
                                                </tr>
                                                <tr>
                                                    <td><input name="metalTag(${metalTagDesc.location})"
                                                               value="${metalTag.tagNumber}" id="metalTagLocation"
                                                               class="form-control"/></td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                                                <td><input name="${set}" type="submit" value="${set}"
                                                           class="btn btn-sm editFormBtn" id="setMetalTags"/></td>
                                            </tr>
                                        </table>
                                    </form>
                                </div>
                            ...
                            <c:if test="${showAcousticTag}">
                                ...
                                <table>
                                    <tr>
                                        <td><%=encprops.getProperty("serialNumber") %>
                                        </td>
                                        <td><c:out value="${empty acousticTag ? '' : acousticTag.serialNumber}"/></td>
                                    </tr>
                                    <tr>
                                        <td>ID:</td>
                                        <td><c:out value="${empty acousticTag ? '' : acousticTag.idNumber}"/></td>
                                    </tr>
                                </table>
                                </p>
                                ...
                                <div>
                                    <p class="editTextTracking"><strong><%=encprops.getProperty("resetAcousticTag")%>
                                    </strong></p>
                                    ...
                                    <table cellpadding="1" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <form name="setAcousticTag" class="editFormTracking"
                                                      id="acousticTagsForm" action="../EncounterSetTags" method="post">
                                                    <input type="hidden" name="encounter" value="${num}"
                                                           id="acousticTagEncounter"/>
                                                    <input type="hidden" name="tagType" value="acousticTag"
                                                           id="acousticTagType"/>
                                                    <input type="hidden" name="id" value="${acousticTag.id}"/>
                                                    <table>
                                                        <tr>
                                                            <td class="formLabel"><%=encprops.getProperty("serialNumber") %>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><input name="acousticTagSerial"
                                                                       value="${acousticTag.serialNumber}"
                                                                       class="form-control" id="acousticTagInput"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="formLabel">ID:</td>
                                                        </tr>
                                                        <tr>
                                                            <td><input name="acousticTagId"
                                                                       value="${acousticTag.idNumber}"
                                                                       id="acousticTagId" class="form-control"/></td>
                                                        </tr>
                                                        <tr>
                                                            <td><input name="${set}" type="submit" value="${set}"
                                                                       class="btn btn-sm editFormBtn"
                                                                       id="setAcousticTags"/></td>
                                                        </tr>
                                                    </table>
                                                </form>
                                            </td>
                            ...
                            <c:if test="${showSatelliteTag}">
                                ...
                                <table>
                                    <tr>
                                        <td><%=encprops.getProperty("name") %>
                                        </td>
                                        <td><c:out value="${satelliteTag.name}"/></td>
                                    </tr>
                                    <tr>
                                        <td><%=encprops.getProperty("serialNumber") %>
                                        </td>
                                        <td><c:out value="${empty satelliteTag ? '' : satelliteTag.serialNumber}"/></td>
                                    </tr>
                                    <tr>
                                        <td>Argos PTT:</td>
                                        <td><c:out
                                                value="${empty satelliteTag ? '' : satelliteTag.argosPttNumber}"/></td>
                                    </tr>
                                </table>
                                </p>
                                ...
                                <div>
                                    <p class="editTextTracking"><strong><%=encprops.getProperty("resetSatelliteTag")%>
                                    </strong></p>
                                    ...
                                    %>
                                    <form name="setSatelliteTag" class="editFormTracking" action="../EncounterSetTags"
                                          method="post">
                                        <input type="hidden" name="tagType" value="satelliteTag" id="satelliteTagType"/>
                                        <input type="hidden" name="encounter" value="${num}"
                                               id="satelliteTagEncounter"/>
                                        <input type="hidden" name="id" value="${satelliteTag.id}" id="satelliteTagId"/>
                                        <table cellpadding="1" cellspacing="0">

                                            <tr>
                                                <td class="formLabel"><%=encprops.getProperty("name") %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                        ...
                                                        <c:forEach items="${satelliteTagNames}" var="satelliteTagName">
                                                            <c:choose>
                                                                <c:when test="${satelliteTagName eq satelliteTag.name}">
                                                                    <option value="${satelliteTagName}"
                                                                            selected="selected">${satelliteTagName}</option>
                                                                </c:when>
                                                                <c:otherwise>
                                            ...
                                            <tr>
                                                <td><input name="satelliteTagSerial" class="form-control"
                                                           value="${satelliteTag.serialNumber}"
                                                           id="satelliteTagSerial"/></td>
                                            </tr>
                                            <tr>
                                                <td class="formLabel">Argos PTT:</td>
                                            </tr>
                                            <tr>
                                                <td><input name="satelliteTagArgosPttNumber"
                                                           value="${satelliteTag.argosPttNumber}"
                                                           id="satelliteTagArgosPttNumber" class="form-control"/></td>
                                            </tr>
                                            <tr>
                                                <td><input name="${set}" type="submit" value="${set}"
                                                           class="btn btn-sm editFormBtn" id="setSatelliteTags"/></td>
                                            </tr>
                                        </table>
                                    </form>
                                </div>
                ...
                <div id="dialogOccurrence" title="<%=encprops.getProperty("assignOccurrence")%>"
            ...
            <div class="col-xs-12 col-sm-6" style="vertical-align:top">
                    ...
                    <tr>
                        <td width="560px" style="vertical-align:top;">
                            ...
                            <h2>
                                ...
                                <button class="btn btn-md" type="button" name="button" id="closeEditDate"
                                        style="display:none;">Close Edit
                                </button>
                            </h2>
                            ...
                            <% } else {
                            %>
                            <h2><img align="absmiddle" src="../images/calendar.png" width="40px"
                                     height="40px"/><%=encprops.getProperty("date") %>
                            </h2>
                            <%}%>
                            ...
                            <p>
                                ...
                                <br/>
                                <em><%=encprops.getProperty("verbatimEventDate")%>
                                </em>:
                                <%
                                ...
                                <br/><em><%=encprops.getProperty("releaseDate") %>
                            </em>: <span id="displayReleaseDate"></span>
                            ...
                            <div>
                                ...
                                <p class="editTextDate"><strong><%=encprops.getProperty("resetEncounterDate")%>
                                </strong></p>
                            ...
                            <script type="text/javascript">
                                $(document).ready(function () {
                                    $("#AddDate").click(function (event) {
                                        ...
                                        $.post("../EncounterSetReleaseDate", {
                                                "encounter": encounter,
                                                "releasedatepicker": releasedatepicker
                                            },
                                            function () {
                            ...
                            <c:if test="${showReleaseDate}">
                                <div>
                                    ...
                                    <p class="editTextDate"><strong><%=encprops.getProperty("setReleaseDate")%>
                                    </strong></p>
                                    <form name="setReleaseDate" class="editFormDate">
                                        ...
                                        <div class="form-group row editFormDate">
                                            <div class="col-sm-4">
                                                <label><%=encprops.getProperty("setReleaseDate")%>
                                                </label>
                                                <p><font size="-1"><%=encprops.getProperty("leaveBlank")%>
                                                </font></p>
                                            </div>
                                            <div class="col-sm-5" id="releaseDiv">
                                                <input type="text" id="releasedatepickerField" name="releasedatepicker"
                                                       class="form-control"/>
                                                <span class="form-control-feedback" id="releaseCheck">&check;</span>
                                                <span class="form-control-feedback" id="releaseError">X</span>
                                            </div>
                                            <div class="col-sm-3">
                                                <input name="AddDate" type="submit" id="AddDate"
                                                       value="<%=encprops.getProperty("setReleaseDate")%>"
                                                       class="btn btn-sm editText"/>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <script type="text/javascript">
                                $(document).ready(function () {
                                    $("#setVerbatimEventDateBtn").click(function (event) {
                                        ...
                                        $.post("../EncounterSetVerbatimEventDate", {
                                                "encounter": encounter,
                            ...
                            <div>
                                ...
                                <p class="editTextDate"><strong><%=encprops.getProperty("setVerbatimEventDate")%>
                                </strong></p>
                                <form name="setVerbatimEventDate" class="editFormDate">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5 col-xs-10" id="verbatimDiv">
                                            <input name="verbatimEventDate" type="text" class="form-control"
                                                   id="verbatimEventDateInput">
                                            <span class="form-control-feedback" id="verbatimCheck">&check;</span>
                                            <span class="form-control-feedback" id="verbatimError">X</span>
                                        </div>
                                        <div class="col-sm-3">
                                            <input name="Set" type="submit" id="setVerbatimEventDateBtn"
                                                   value="<%=encprops.getProperty("set")%>"
                                                   class="btn btn-sm editFormBtn">
                                        </div>
                                    </div>
                ...
                <div id="add-image-zone" class="bc4 declutter">
                    ...
                    <h2 style="text-align:left"><%=encprops.getProperty("addImage") %>
                    </h2>
                    ...
                    <div class="flow-box bc4" style="text-align:center">
                        ...
                        <div id="upcontrols">
                            <input type="file" id="file-chooser" multiple accept="audio/*,video/*,image/*"
                                   onChange="return filesChanged(this)"/>
                            <div id="flowbuttons">

                                <button id="reselect-button" class="btn" style="display:none">choose a different image
                                </button>
                ...
                <div class="declutter">
                    ...
                    <% if (isOwner && CommonConfiguration.isCatalogEditable(context)) { %>
                    <h2>
                        <img align="absmiddle" src="../images/Note-Book-icon.png" width="40px"
                             height="40px"/> <%=encprops.getProperty("observationAttributes") %>
                        <button class="btn btn-md" type="button" name="button" id="editObservation">Edit</button>
                        <button class="btn btn-md" type="button" name="button" id="closeEditObservation"
                                style="display:none;">Close Edit
                        </button>
                    </h2>
                    ...
                    <% } else {
                    %>
                    <h2><img align="absmiddle" src="../images/Note-Book-icon.png" width="40px"
                             height="40px"/> <%=encprops.getProperty("observationAttributes") %>
                    </h2>
                    <%}%>
                    ...
                    <%
                        if (CommonConfiguration.showProperty("showTaxonomy", context)) {
                            ...
                            if ((enc.getGenus() != null) && (enc.getSpecificEpithet() != null)) {
                                genusSpeciesFound = enc.getGenus() + " " + enc.getSpecificEpithet();
                            }
                    %>

                    <p class="para"><img align="absmiddle" src="../images/taxontree.gif">
                        <%=encprops.getProperty("taxonomy")%>:<em><span
                                id="displayTax"><%=genusSpeciesFound%></span></em>&nbsp;<%
                        %>
                        <%
                        %>
                    </p>
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("resetTaxonomy")%>
                        </strong></p>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <select name="genusSpecies" id="genusSpecies" class="form-control" size="1">
                                        <option value="unknown"><%=encprops.getProperty("notAvailable")%>
                                        </option>
                                        ...
                                        <option value="<%=CommonConfiguration.getProperty(currentGenuSpecies,context)%>"><%=CommonConfiguration.getProperty(currentGenuSpecies, context).replaceAll("_", " ")%>
                                        </option>
                                        <%
                                                    genusTaxNum++;
                                                } else {
                                ...
                                <div class="col-sm-3">
                                    <input name="<%=encprops.getProperty("set")%>" type="submit" id="taxBtn"
                                           value="<%=encprops.getProperty("set")%>" class="btn btn-sm editFormBtn"/>
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("resetStatus")%>
                        </strong></p>
                        ...
                        <form name="livingStatusForm" class="editFormObservation">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input name="Add" type="submit" id="addStatus"
                                           value="<%=encprops.getProperty("resetStatus")%>" class="btn btn-sm"/>
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("resetSex")%>
                        </strong></p>
                        ...
                        <form name="setxencshark" class="editFormObservation">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input name="Add" type="submit" id="addSex"
                                           value="<%=encprops.getProperty("resetSex")%>"
                                           class="btn btn-sm editFormBtn"/>
                    ...
                    <p class="para declutter"><%=encprops.getProperty("scarring") %>&nbsp;
                        ...
                        <%
                            ...
                            if (enc.getDistinguishingScar() != null) {
                                recordedScarring = enc.getDistinguishingScar();
                            }
                        %>
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("editScarring")%>
                        </strong></p>
                        <form name="setencsize" class="editFormObservation">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <textarea name="scars" class="form-control"
                                              id="scarInput"><%=enc.getDistinguishingScar()%></textarea>
                                </div>
                                <div class="col-sm-3">
                                    <input name="Add" type="submit" id="addScar"
                                           value="<%=encprops.getProperty("resetScarring")%>" class="btn btn-sm"/>
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("editBehaviorComments")%>
                        </strong></p>
                        <span class="editTextObservation"><em><font
                                size="-1"><%=encprops.getProperty("leaveBlank")%></font></em></span>
          ...
          %>
                                ...
                                <div class="col-sm-3">
                                    <input name="EditBeh" type="submit" id="editBehavior"
                                           value="<%=encprops.getProperty("submitEdit")%>" class="btn btn-sm"/>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            $("#editPattern").click(function (event) {
                                ...
                                $.post("../EncounterSetPatterningCode", {
                                        "number": number,
                                        "patterningCode": patterningCode
                                    },
                                    function () {
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("editPatterningCode")%>
                        </strong></p>
                        <span class="editTextObservation"><em><font
                                size="-1"><%=encprops.getProperty("leaveBlank")%></font></em></span>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    ...
                                    <select name="patterningCode" id="colorCode" class="form-control" size="1">
                                        ...
                                        <option value="<%=CommonConfiguration.getProperty(currentLoc,context)%>"><%=CommonConfiguration.getProperty(currentLoc, context)%>
                                        </option>
                                        <%
                                                    patternTaxNum++;
                                                } else {
                                ...
                                <div class="col-sm-3">
                                    <input name="EditPC" type="submit" id="editPattern"
                                           value="<%=encprops.getProperty("submitEdit")%>" class="btn btn-sm"/>
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("resetLifeStage")%>
                        </strong></p>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <select name="lifeStage" id="lifeStage" class="form-control" size="1">
                                        ...
                                        <option value="<%=CommonConfiguration.getProperty(currentLifeStage,context)%>"><%=CommonConfiguration.getProperty(currentLifeStage, context)%>
                                        </option>
                                        <%
                                                    lifeTaxNum++;
                                                } else {
                                ...
                                <div class="col-sm-3">
                                    <input name="<%=encprops.getProperty("set")%>" type="submit" id="addLife"
                                           value="<%=encprops.getProperty("set")%>" class="btn btn-sm editFormBtn"/>
                    ...
                    <p class="declutter para"><%=encprops.getProperty("comments") %>
                        ...
                        <%
                            ...
                            if (enc.getComments() != null) {
                                recordedComments = enc.getComments();
                            }
                        %>
                    ...
                    <div>
                        ...
                        <p class="editTextObservation"><strong><%=encprops.getProperty("editSubmittedComments")%>
                        </strong></p>
                        <form name="setComments" class="editFormObservation">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <textarea name="fixComment" class="form-control"
                                              id="commentInput"><%=enc.getComments()%></textarea>
                                </div>
                                <div class="col-sm-3">
                                    <input name="EditComm" type="submit" id="editComment"
                                           value="<%=encprops.getProperty("submitEdit")%>" class="btn btn-sm"/>
                    ...
                    <div class="declutter">
                        ...
                        <h2>
                            ...
                            <button class="btn btn-md" type="button" name="button" id="closeEditDynamic"
                                    style="display:none;">Close Edit
                            </button>
                        </h2>
                        ...
                        <% } else {
                        %>
                        <h2><img align="absmiddle"
                                 src="../images/lightning_dynamic_props.gif"/> <%=encprops.getProperty("dynamicProperties") %>
                        </h2>
                        ...
                        <p class="para"><em><%=nm%>
                                ...
                                %>
                            <!-- start dynamic form -->
                        <div id="dialogDP<%=nm %>" title="<%=encprops.getProperty("set")%> <%=nm %>"
                             class="editFormDynamic">
                            <p class="editTextDynamic"><strong><%=encprops.getProperty("set")%> <%=nm %>
                            </strong></p>
                            <p class="editTextDynamic"><em><small><%=encprops.getProperty("setDPMessage") %>
                            </small></em></p>
                            ...
                            <form name="addDynProp" action="../EncounterSetDynamicProperty" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="value" type="text" class="form-control" id="dynInput"
                                               value="<%=vl %>"/>
                                    </div>
                                    <div class="col-sm-4">
...
//display a message if none are defined
                    ...
                    <div id="dialogDPAdd" title="<%=encprops.getProperty("addDynamicProperty")%>"
                         class="editFormDynamic">
                        <p class="editTextDynamic"><strong><%=encprops.getProperty("addDynamicProperty")%>
                        </strong></p>
                        <form name="addDynProp" action="../EncounterSetDynamicProperty" method="post"
                              class="editFormDynamic">
                            <input name="number" type="hidden" value="<%=num%>"/>
                            ...
                            <input name="Set" type="submit" id="addDynPropBtn"
                                   value="<%=encprops.getProperty("initCapsSet")%>" class="btn btn-sm editFormBtn"/>
                        </form>
                    </div>
...
%>
        ...
        <div class="declutter xadmin-only">
            ...
            <p class="para"><img align="absmiddle" src="../images/microscope.gif"/>
                <strong><%=encprops.getProperty("tissueSamples") %>
                </strong>
            </p>
            <p class="para">
                <a class="addBioSample toggleBtn" class="launchPopup"><img align="absmiddle" width="24px"
                                                                           style="border-style: none;"
                                                                           src="../images/Crystal_Clear_action_edit_add.png"/></a>&nbsp;<a
                    class="addBioSample toggleBtn" class="launchPopup"><%=encprops.getProperty("addTissueSample") %>
            </a>
            </p>
                    ...
                    <table cellspacing="2" bordercolor="#FFFFFF">
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("alternateSampleID")%>
                            </td>
                            <td><input name="alternateSampleID" type="text" size="20" maxlength="100"
                                       value="<%=alternateSampleID %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="tissueType" id="tissueType">
                                    ...
                                    <option value="<%=CommonConfiguration.getProperty(currentLoc,context)%>" <%=selected %>><%=CommonConfiguration.getProperty(currentLoc, context)%>
                                    </option>
                                    <%
                                                tissueTaxNum++;
                                            } else {
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("preservationMethod")%>
                            </td>
                            <td><input name="preservationMethod" type="text" size="20" maxlength="100"
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("storageLabID")%>
                            </td>
                            <td><input name="storageLabID" type="text" size="20" maxlength="100"
                                       value="<%=storageLabID %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input name="samplingProtocol" type="text" size="20" maxlength="100"
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("samplingEffort")%>
                            </td>
                            <td><input name="samplingEffort" type="text" size="20" maxlength="100"
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("fieldNumber")%>
                            </td>
                            <td><input name="fieldNumber" type="text" size="20" maxlength="100"
                                       value="<%=fieldNumber %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("fieldNotes")%>
                            </td>
                            <td><input name="fieldNNotes" type="text" size="20" maxlength="100"
                                       value="<%=fieldNotes %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("eventRemarks")%>
                            </td>
                            <td><input name="eventRemarks" type="text" size="20" value="<%=eventRemarks %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("institutionID")%>
                            </td>
                            <td><input name="institutionID" type="text" size="20" maxlength="100"
                                       value="<%=institutionID %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("collectionID")%>
                            </td>
                            <td><input name="collectionID" type="text" size="20" maxlength="100"
                                       value="<%=collectionID %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("collectionCode")%>
                            </td>
                            <td><input name="collectionCode" type="text" size="20" maxlength="100"
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("datasetID")%>
                            </td>
                            <td><input name="datasetID" type="text" size="20" maxlength="100" value="<%=datasetID %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                %>
                                <%=encprops.getProperty("datasetName")%>
                            </td>
                            <td><input name="datasetName" type="text" size="20" maxlength="100"
                                       value="<%=datasetName %>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input name="EditTissueSample" type="submit" id="EditTissueSample"
                                       value="<%=encprops.getProperty("set")%>" class="btn btn-sm editFormBtn"/>
                            </td>
                        </tr>
                        </td>
...
%>
            <table width="100%" class="table table-bordered table-striped tissueSampleTable">
                <tr>
                    <th><%=encprops.getProperty("sampleID") %>
                    </th>
                    <th><%=encprops.getProperty("values") %>
                    </th>
                    <th><%=encprops.getProperty("analyses") %>
                    </th>
                    <th><%=encprops.getProperty("editTissueSample") %>
                    </th>
                    <th><%=encprops.getProperty("removeTissueSample") %>
                    </th>
                </tr>
                <%
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="border-style: none;"><strong><span
                                        class="caption"><%=encprops.getProperty("haplotype") %>
                                </strong></span></strong>: <span class="caption"><%=mito.getHaplotype() %>
				<%
                ...
                %>
                                ...
                                <td style="border-style: none;">
                                    <a id="haplo<%=mito.getAnalysisID() %>" class="toggleBtn"><img width="20px"
                                                                                                   height="20px"
                                                                                                   style="border-style: none;"
                                    ...
                                    <div id="dialogHaplotype<%=mito.getAnalysisID() %>"
                                         title="<%=encprops.getProperty("setHaplotype")%>" style="display:none">
                                            ...
                                            <table cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <%=encprops.getProperty("analysisID")%>
                                                        (<%=encprops.getProperty("required")%>)
                                                    </td>
                                                    <td>
                                                        <%
                                                            ...
                                                            mtDNA = mito;
                                                        %>
                                                        <input name="analysisID" type="text" size="20" maxlength="100"
                                                               value="<%=mtDNA.getAnalysisID() %>"/></td>
                                                </tr>
                                                <tr>
                                                    <%
                                                    ...
                                                    %>
                                                    <td><%=encprops.getProperty("haplotype")%>
                                                        (<%=encprops.getProperty("required")%>)
                                                    </td>
                                                    <td>
                                                        <input name="haplotype" type="text" size="20" maxlength="100"
                                                               value="<%=haplotypeString %>"/>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    %>
                                                    <td><%=encprops.getProperty("processingLabTaskID")%>
                                                    </td>
                                                    <td>
                                                        <input name="processingLabTaskID" type="text" size="20"
                                                               maxlength="100" value="<%=processingLabTaskID %>"/>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        %>
                                                        <%=encprops.getProperty("processingLabName")%>
                                                    </td>
                                                    <td>
                                                        <input name="processingLabName type=" text" size="20"
                                                        maxlength="100" value="<%=processingLabName %>" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        %>
                                                        <%=encprops.getProperty("processingLabContactName")%>
                                                    </td>
                                                    <td>
                                                        <input name="processingLabContactName type=" text" size="20"
                                                        maxlength="100" value="<%=processingLabContactName %>" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        %>
                                                        <%=encprops.getProperty("processingLabContactDetails")%>
                                                    </td>
                                                    <td>
                                                        <input name="processingLabContactDetails type=" text" size="20"
                                                        maxlength="100" value="<%=processingLabContactDetails %>" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <input name="sampleID" type="hidden"
                                                               value="<%=thisSample.getSampleID() %>"/>
                                                        <input name="number" type="hidden" value="<%=num%>"/>
                                                        <input name="action" type="hidden" value="setHaplotype"/>
                                                        <input name="EditTissueSample" type="submit"
                                                               id="EditTissueSample"
                                                               value="<%=encprops.getProperty("set")%>"/>
...
$("a#haplo<%=mito.getAnalysisID() %>").click(function() {
  dlgHaplotype<%=mito.getAnalysisID() %>.dialog("open");
                            ...
                            <tr>
                                <td style="border-style: none;"><strong><span
                                        class="caption"><%=encprops.getProperty("geneticSex") %>
                                </strong></span></strong>: <span class="caption"><%=mito.getSex() %>
				<%
                    if (!mito.getSuperHTMLString().equals("")) {
                %>
				<em>
                ...
                %>
                                ...
                                <td style="border-style: none;">
                                    <a id="setSex<%=thisSample.getSampleID() %>" class="launchPopup"><img width="20px"
                                                                                                          height="20px"
                                                                                                          style="border-style: none;"
                                    ...
                                    <div id="dialogSexSet<%=thisSample.getSampleID().replaceAll("[-+.^:,]","") %>"
                                         title="<%=encprops.getProperty("setSexAnalysis")%>" style="display:none">
                                            ...
                                            <table cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <%=encprops.getProperty("analysisID")%>
                                                        (<%=encprops.getProperty("required")%>)<br/>
                                                        <%
                                                            SexAnalysis mtDNA = mito;
                                                            String analysisIDString = mtDNA.getAnalysisID();
                                                        %>
                                                    </td>
                                                    <td><input name="analysisID" type="text" size="20" maxlength="100"
                                                               value="<%=analysisIDString %>"/><br/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        %>
                                                        <%=encprops.getProperty("geneticSex")%>
                                                        (<%=encprops.getProperty("required")%>)<br/>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="processingLabContactName type=" text" size="20"
                                                        maxlength="100" value="<%=processingLabContactName %>" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="processingLabContactDetails type=" text" size="20"
                                                        maxlength="100" value="<%=processingLabContactDetails %>" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input name="EditTissueSampleSexAnalysis" type="submit"
                                                               id="EditTissueSampleSexAnalysis"
                                                               value="<%=encprops.getProperty("set")%>"/>
                            ...
                            <tr>
                                <td style="border-style: none;">
                                    <p><span
                                            class="caption"><strong><%=encprops.getProperty("msMarkers") %></strong></span>
                                        <%
                                            if ((enc.getIndividualID() != null) && (request.getUserPrincipal() != null)) {
                                        %>
                                        <a href="../individualSearch.jsp?individualDistanceSearch=<%=enc.getIndividualID()%>"><img
                                                height="20px" width="20px" align="absmiddle"
                                                alt="Individual-to-Individual Genetic Distance Search"
                                                src="../images/Crystal_Clear_app_xmag.png"></img></a>
                                        <%
                                            }
                                        %>
                                    </p>
                        ...
                        %>
                                ...
                                <td style="border-style: none;">
                                    <a class="launchPopup" id="msmarkersSet<%=thisSample.getSampleID()%>">
                                        <img width="20px" height="20px" style="border-style: none;"
                                             src="../images/Crystal_Clear_action_edit.png"/>
                                    </a>
                                </td>
                                <td style="border-style: none;">
                                    <a onclick="return confirm('<%=encprops.getProperty("deleteMSMarkers") %>');"
                                    ...
                                    <div id="dialogMSMarkersSet<%=thisSample.getSampleID().replaceAll("[-+.^:,]","")%>"
                                         title="<%=encprops.getProperty("setMsMarkers")%>" style="display:none">

                                        <form id="setMsMarkers" action="../TissueSampleSetMicrosatelliteMarkers"
                                              method="post">
                                            ...
                                            <table cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="processingLabContactDetails" type="text" size="20"
                                                               maxlength="100"
                                                               value="<%=processingLabContactDetails %>"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
 		...
 		//begin setting up the loci and alleles
 		  ...
 		  %>
                                                        <br/><%=encprops.getProperty("locus") %>: <input
 				...
 				%>
                                                            <%=encprops.getProperty("allele") %>: <input
...
var dlgMSMarkersSet<%=thisSample.getSampleID().replaceAll("[-+.^:,]","")%> = $("#dialogMSMarkersSet<%=thisSample.getSampleID().replaceAll("[-+.^:,]","")%>").dialog({
  ...
  width: 600
                            ...
                            <tr>
                                <td style="border-style: none;"><strong><span
                                        class="caption"><%=mito.getMeasurementType()%> <%=encprops.getProperty("measurement") %></span></strong><br/>
                                    <span class="caption"><%=mito.getValue().toString() %> <%=mito.getUnits() %> (<%=mito.getSamplingProtocol() %>)
				<%
                    if (!mito.getSuperHTMLString().equals("")) {
                %>
				<em>
                ...
                %>
                                ...
                                <td style="border-style: none;"><a class="launchPopup"
                                    ...
                                    <div id="dialogSetBiomeasure4<%=thisSample.getSampleID().replaceAll("[-+.^:,]","") %>"
                                         title="<%=encprops.getProperty("setBiologicalMeasurement")%>"
                                         style="display:none">
                                            ...
                                            <table cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        %>
                                                        <p><select size="<%=(numProps+1) %>" name="measurementType"
                                                                   id="measurementType">
                                                            <%
                                                            ...
                                                            %>
                                                            <option value="<%=values.get(y) %>" <%=selected %>><%=values.get(y) %><%=units %>
                                                            </option>
                                                            <%
                                                                }
                                                            %>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        %>
                                                        <%=encprops.getProperty("value")%>
                                                        (<%=encprops.getProperty("required")%>)<br/>
                                                    </td>
                                                    <td><input name="value" type="text" size="20" maxlength="100"
                                                               value="<%=thisValue %>"></input>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p><select size="<%=(protonumProps+1) %>"
                                                            ...
                                                            %>
                                                            <option value="<%=protovalues.get(y) %>" <%=selected %>><%=protovalues.get(y) %>
                                                            </option>
                                                            <%
                                                                }
                                                            %>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input name="action" type="hidden"
                                                               value="setBiologicalMeasurement"/>
      ...
      <a class="toggleBtn addHaplotype<%=thisSample.getSampleID() %>"><%=encprops.getProperty("addHaplotype") %></a>
                        ...
                        <div id="dialogHaplotype4<%=thisSample.getSampleID().replaceAll("[-+.^:,]","") %>"
                             title="<%=encprops.getProperty("setHaplotype")%>" style="display:none">
                            <form id="setHaplotype" action="../TissueSampleSetHaplotype" method="post">
                                <table cellpadding="1" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        %>
                                        <td><%=encprops.getProperty("haplotype")%>(<%=encprops.getProperty("required")%>
                                            )
                                        </td>
                                        <td>
                                            <input name="haplotype" type="text" size="20" maxlength="100"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="processingLabTaskID" type="text" size="20" maxlength="100"
                                                   value="<%=processingLabTaskID %>"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="processingLabName type=" text" size="20" maxlength="100"
                                            value="<%=processingLabName %>" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="processingLabContactName type=" text" size="20" maxlength="100"
                                            value="<%=processingLabContactName %>" />
                                        </td>
                                    </tr>
      ...
      <span class="caption">
        ...
        <a class="msmarkersAdd<%=thisSample.getSampleID()%> toggleBtn"><%=encprops.getProperty("addMsMarkers") %></a>
                        ...
                        <div id="dialogMSMarkersAdd<%=thisSample.getSampleID().replaceAll("[-+.^:,]","")%>"
                             title="<%=encprops.getProperty("setMsMarkers")%>" style="display:none">
                            ...
                            <form id="setMsMarkers" action="../TissueSampleSetMicrosatelliteMarkers" method="post">
                                ...
                                <table cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="processingLabTaskID" type="text" size="20" maxlength="100"
                                                   value="<%=processingLabTaskID %>"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="processingLabName" type="text" size="20" maxlength="100"
                                                   value="<%=processingLabName %>"/>
                                        </td>
                                    </tr>
 		...
 		//begin setting up the loci and alleles
 		  ...
 		  for(int locus=0;locus<numLoci;locus++){
 			 ...
 			 if((msDNA.getLoci()!=null)&&(locus<msDNA.getLoci().size())){locusNameValue=msDNA.getLoci().get(locus).getName();}
 		  %>
                                            <br/><%=encprops.getProperty("locus") %>: <input name="locusName<%=locus %>"
                                                                                             type="text" size="10"
                                                                                             value="<%=locusNameValue %>"/><br/>
                                                <%
 				for(int ploid=0;ploid<numPloids;ploid++){
  ...
  <a class="addSex<%=thisSample.getSampleID() %> toggleBtn"><%=encprops.getProperty("addGeneticSex") %></a>
                        ...
                        <div id="dialogSex4<%=thisSample.getSampleID().replaceAll("[-+.^:,]","") %>"
                             title="<%=encprops.getProperty("setSexAnalysis")%>" style="display:none">
      ...
      <a class="toggleBtn addBioMeasure<%=thisSample.getSampleID() %>"><%=encprops.getProperty("addBiologicalMeasurement") %></a>
                        ...
                        <div id="dialogBiomeasure4<%=thisSample.getSampleID().replaceAll("[-+.^:,]","") %>"
                             title="<%=encprops.getProperty("setBiologicalMeasurement")%>" style="display:none">
                                ...
                                <table cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            %>
                                            <input name="measurementType" type="text" size="20" maxlength="100"
                                                   value="<%=type %>"/>
                                            <%
                                                }
                                            %>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            %>
                                            <%=encprops.getProperty("value")%> (<%=encprops.getProperty("required")%>
                                            )<br/>
                                        </td>
                                        <td><input name="value" type="text" size="20" maxlength="100"
                                                   value="<%=thisValue %>"></input>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            %>
                                            <p><select size="<%=(protonumProps+1) %>" name="samplingProtocol"
                                                       id="samplingProtocol">
                                                <%
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input name="EditTissueSampleBiomeasurementAnalysis" type="submit"
                                                   id="EditTissueSampleBioMeasurementAnalysis"
                                                   value="<%=encprops.getProperty("set")%>"/>
                    ...
                    <td><a id="sample"
                           href="encounter.jsp?number=<%=enc.getCatalogNumber() %>&sampleID=<%=thisSample.getSampleID()%>&edit=tissueSample&function=1"><img
                            width="24px" style="border-style: none;" src="../images/Crystal_Clear_action_edit.png"/></a>
                    </td>
                    <td><a onclick="return confirm('<%=encprops.getProperty("deleteTissue") %>');"
                           href="../EncounterRemoveTissueSample?encounter=<%=enc.getCatalogNumber()%>&sampleID=<%=thisSample.getSampleID()%>"><img
                            style="border-style: none;width: 40px;height: 40px;" src="../images/cancel.gif"/></a></td>
                </tr>
                <%
                    }
                %>
            ...
            %>
            <p class="para"><%=encprops.getProperty("noTissueSamples") %>
            </p>
            <%
                    }
...
//now iterate through the jspImport# declarations in encounter.properties and import those files locally
            ...
            <div class="ia-match-filter-dialog">
                <h2><%=encprops.getProperty("matchFilterHeader")%>
                </h2>
                <div class="ia-match-filter-title search-collapse-header" style="padding-left:0; border:none;">
                    <span class="el el-lg el-chevron-right rotate-chevron"
                          style="margin-right: 8px;"></span><%=encprops.getProperty("locationID")%> &nbsp; <span
                        class="item-count" id="total-location-count"></span>
                </div>
                    ...
                    <div style="width: 100%; max-height: 200px; overflow-y: scroll">
                        ...
                        <div>
                            <div style="margin-top: 10px; color: #660;" class="item">
                                <input type="checkbox" id="match-filter-location-unlabeled"
                                       name="match-filter-location-id" value="__NULL__"
                                       onChange="iaMatchFilterLocationCountUpdate();"/>
                                <label for="match-filter-location-unabled"><%=encprops.getProperty("matchFilterLocationUnlabeled")%>
                                </label>
...
*/
                ...
                <div class="ia-match-filter-title"><%=encprops.getProperty("matchFilterOwnership")%>
                </div>
                <div class="item">
                    <input type="checkbox" id="match-filter-owner-me" name="match-filter-owner" value="me"/>
                    <label for="match-filter-owner-me"><%=encprops.getProperty("matchFilterOwnershipMine")%>
                    </label>
                </div>
                <!--  not yet implemented!
    <div class="item">
...
-->
                ...
                <%
                    ...
                    myShepherd.closeDBTransaction();
                %>
                <p class="para">There is no corresponding encounter number in the database. Please double-check the
                    encounter number and try again.</p>

                <form action="encounter.jsp" method="post" name="encounter"><strong>Go
                    to encounter: </strong> <input name="number" type="text" value="" size="20"> <input name="Go"
                                                                                                        type="submit"
                                                                                                        value="Submit"/>
                </form>
