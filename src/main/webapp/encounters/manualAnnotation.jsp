...
*/
	...
	if(viewpoint!=null){
		clist = "<p>2. Select annotation iaClass: <select name=\"iaClass\" onChange=\"return pulldownUpdate(this);\"><option value=\"\">CHOOSE</option>";
                clist += "<option>black_white</option>";
                clist += "<option>black</option>";
                clist += "<option>calico</option>";
                clist += "<option>dark_grey</option>";
                clist += "<option>tabby_torbie</option>";
                clist += "<option>tabby_torbie_white</option>";
                clist += "<option>orange</option>";
                clist += "<option>beige_cream_white</option>";
		clist += "</select></p>";
		//q2.closeAll();
	}
...
/*  NOTE: this is not true for kitizen
	//also don't clone if this is a part
