<%@ page contentType="text/html; charset=utf-8" language="java"
  ...
  context=ServletUtilities.getContext(request);
    ...
    try{
     ...
     <p>Excel Metadata Summary <a href="http://<%=CommonConfiguration.getURLLocation(request)%>/EncounterSearchExportMetadataExcel?<%=request.getQueryString()%>"><%=map_props.getProperty("clickHere")%></a>
 		 </p>
