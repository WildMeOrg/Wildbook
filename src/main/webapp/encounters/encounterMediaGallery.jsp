  ...
  for(int f=0;f<numEncs;f++){
      ...
      if (!enc.canUserAccess(request)) {
        ...
        //System.out.println("EMG: got "+anns.size()+" anns");
		      ...
		      //Start caption render JSP side ... keeping old version in case break -MF, 12.22.2020
          ...
          //     capos[0]+=individualID;
		      ...
		      // capos[0]+=encprops.getProperty("location")+" "+enc.getLocation()+"<br>"+encprops.getProperty("locationID")+" "+enc.getLocationID()+"<br>"+encprops.getProperty("paredMediaAssetID")+" <a style=\"color: white;\" target=\"_blank\" href=\"../obrowse.jsp?type=MediaAsset&id="+ma.getId()+"\">"+ma.getId()+"</a></p>"; // ... keeping old version in case break -MF, 12.22.2020
