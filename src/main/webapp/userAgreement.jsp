...
<div class="container maincontent">
      ...
      Any photographs that you submit to Amphibian and Reptile Wildbook remain YOUR intellectual property, and Amphibian and Reptile Wildbook and its participants agree not to use them for media purposes without your express permission. However, by submitting photographs and cetacean sighting data you give Wild Me and its participants permission to use this data for research and conservation purposes. Data, such as animal identifications, may be derived from your submissions. These data become the intellectual property of Amphibian and Reptile Wildbook and may not be published or re-used without the express permission of Amphibian and Reptile Wildbook.
      ...
      <h3>LINKING</h3>
      We welcome links to Amphibian and Reptile Wildbook. You are usually free to establish a hypertext link to any of Amphibian and Reptile Wildbook pages so long as the link does not state or imply any sponsorship of your site by Amphibian and Reptile Wildbook. Pages linking to the Library should include, to the best of your ability, factually correct information about Amphibian and Reptile Wildbook and cetaceans. In other words, please respect the scientific mission of Amphibian and Reptile Wildbook and help us ensure that only accurate information about cetaceans is disseminated.
      <h3>FRAMING</h3>
