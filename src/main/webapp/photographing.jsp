...
<div class="container maincontent">
		  <h2>Photographing A Lynx</h2>
	
			
			<p>Did you know that by photographing a lynx you can directly contribute to a global effort to better understand and protect these amazing animals? 


 The lynx is listed as <em>vulnerable </em>to extinction  in the <em><a href="http://www.iucnredlist.org/search/details.php/19488/all">IUCN Red List of Threatened Species</a>. </em>Photographs showing the distinctive patterning and scarring on lynx are used to
	    ...
	    and to take specific action to protect them.</p>
			<p>The most important thing to remember when attempting to photograph a lynx is to remain at least 3 meters (10 feet) away from the shark. Touching or blocking the path of a
			lynx may negatively influence its behavior and affect scientists' ability to photograph it again in the future.</p>
			<p>The following types of photographs (or frame grabs from video), listed in order of importance, can be used to uniquely identify individual lynx.</p>
			...
			<p>Once you have your lynx photographs or frame grabs from video, you can submit them directly to the Wildbook for Lynx at:<br />
			...
			<p>Thank you for contributing to this global effort to protect the lynx! </p>
			<p>&nbsp;</p>
