...
<div class="container maincontent">
			...
			<p>Our computer vision software uses the patttern on side of the turtle's head for identification. Images where the turtle's head is angled or somewhate blurry can still be useful, but a good shot from the side is best.</p></p>
			...
			<p><small>The above image would perform fine with matching.</small></p>
			<p>Please include as much information about the turtle in your image as you can. The most important pieces are date and location. With this and an identifiable image, we can start to track individuals and populations.</p>
