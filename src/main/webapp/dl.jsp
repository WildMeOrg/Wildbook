...
try {
    ...
    // some older WB have plenty of assets the don't have a "_master" so lets fall back to "_mid". only other possibility is orig
    if ((masters == null) || (masters.size() < 1)) {
        masters = ma.findChildrenByLabel(myShepherd, "_mid");
    }
    ...
    System.out.println("DL: getting params for asset ");
    ...
    System.out.println("DL: finished asset download ");
