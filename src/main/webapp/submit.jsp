...
String context=" context0"; context=ServletUtilities.getContext(request); String
      mapKey=CommonConfiguration.getGoogleMapsKey(context); GregorianCalendar cal=new GregorianCalendar(); int
      nowYear=cal.get(1); //setup our Properties object to hold all properties Properties props=new Properties();
      //String langCode="en" ; String langCode=ServletUtilities.getLanguageCode(request); //set up the file input stream
      //props.load(getClass().getResourceAsStream("/bundles/" + langCode + "/submit.properties" ));
      props=ShepherdProperties.getProperties("submit.properties", langCode, context); Properties
      recaptchaProps=ShepherdProperties.getProperties("recaptcha.properties", "" , context); Properties
      socialProps=ShepherdProperties.getProperties("socialAuth.properties", "" , context); long
      maxSizeMB=CommonConfiguration.getMaxMediaSizeInMegabytes(context); long maxSizeBytes=maxSizeMB * 1048576; //let's
      pre-populate important info for logged in users String submitterName="" ; String submitterEmail="" ; String
      affiliation=(request.getParameter("organization")!=null) ? request.getParameter("organization") : "" ; String
      project="" ; Shepherd myShepherd=new Shepherd(context); User user=null; myShepherd.setAction("submit.jsp1");
      myShepherd.beginDBTransaction(); String
      qualifier=ShepherdProperties.getOverwriteStringForUser(request,myShepherd); if(qualifier==null)
      {qualifier="default" ;} else{qualifier=qualifier.replaceAll(".properties","");} if(request.getRemoteUser()!=null){
      submitterName=request.getRemoteUser(); if(myShepherd.getUser(submitterName)!=null){
      user=myShepherd.getUser(submitterName); if(user.getFullName()!=null){submitterName=user.getFullName();}
      ...
      if(user.getUserProject()!=null){project=user.getUserProject();} } } myShepherd.rollbackDBTransaction();
      myShepherd.closeDBTransaction(); boolean useCustomProperties=User.hasCustomProperties(request); // don't want to
      call this a bunch %>
	...
	%>
      ...
      <% if((CommonConfiguration.getProperty("allowSocialMediaLogin",
        context)!=null)&&(CommonConfiguration.getProperty("allowSocialMediaLogin", context).equals("true"))){ %>
              ...
              <div class="container-fluid page-content" role="main">
                ...
                <div class="container maincontent">
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <h1 class="intro">
                      <%=props.getProperty("submit_report") %>
                    </h1>

                    <p>
                      <%=props.getProperty("submit_overview") %>
                    </p>
                  ...
                  <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
                    ...
                    <form id="encounterForm" action="spambot.jsp" method="post" enctype="multipart/form-data"
                      name="encounter_submission" target="_self" dir="ltr" lang="en" onsubmit="return false;"
                      ...
                      <fieldset>
                        <h3>
                          <%=props.getProperty("submit_image")%>
                        </h3>
                        <p>
                          <%=props.getProperty("submit_pleaseadd")%>
                        </p>
                        ...
                        <div>
                          <div id="submitupload" class="input-file-drop">
                            <% if (isIE) { %>
                              <div>
                                <%=props.getProperty("dragInstructionsIE")%>
                              </div>
                              <input class="ie" name="theFiles" type="file"
                                accept=".jpg, .jpeg, .png, .bmp, .gif, .mov, .wmv, .avi, .mp4, .mpg" multiple size="30"
                                onChange="updateList(this);" />
                              <% } else { %>
                                <input class="nonIE" name="theFiles" id="theFiles" type="file"
                                  accept=".jpg, .jpeg, .png, .bmp, .gif, .mov, .wmv, .avi, .mp4, .mpg" multiple
                                  size="30" onChange="updateList(this);" />
                                <div><span>
                                    <%=props.getProperty("dragInstructions")%>
                                  </span></div>
                                <% } %>
                      ...
                      <fieldset>
                        <h3>
                          <%=props.getProperty("dateAndLocation")%>
                        </h3>
                        ...
                        <div class="form-group required">
                          ...
                          <div class="form-group required">
                            ...
                            <div class="form-inline col-xs-12 col-sm-12 col-md-6 col-lg-6">
                              ...
                              <input class="form-control" type="text" style="position: relative; z-index: 101;"
                                id="datepicker" name="datepicker" size="20" />
                            </div>
                          ...
                          <% if(CommonConfiguration.showReleaseDate(context)){ %>
                            ...
                            <div class="form-inline col-xs-12 col-sm-12 col-md-6 col-lg-6">
                              <label class="control-label text-danger">
                                <%=props.getProperty("submit_releasedate") %>
                              </label>
                              <input class="hasDatepicker form-control" type="text"
                                style="position: relative; z-index: 101;" id="releasedatepicker" name="releaseDate"
                                size="20" onChange="$('.required-missing').removeClass('required-missing');>
      </div>
                                ...
                                <div class="form-group required">
                                  <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                    <label class="control-label">
                                      <%=props.getProperty("locationID") %>
                                    </label>
                                  </div>

                                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-8">
                                    <%=LocationID.getHTMLSelector(false,
                                      null,qualifier,"locationID","locationID","form-control") %>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-8">
                                      <select name="country" id="country" class="form-control">
                                        ...
                                        <% List<String> countries = (useCustomProperties)
                                          ...
                                          : CommonConfiguration.getIndexedPropertyValues("country", context); //passing
                                          context doesn't check for custom props
    ...
    -->
                                      ...
                                      <div class=" form-group form-inline">
                                        <div class="col-xs-12 col-sm-6">
                                          <label class="control-label pull-left">
                                            <%=props.getProperty("submit_gpslatitude") %>&nbsp;
                                          </label>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                          <label class="control-label  pull-left">
                                            <%=props.getProperty("submit_gpslongitude") %>&nbsp;
                                          </label>
                                    ...
                                    <% if(CommonConfiguration.showProperty("maximumDepthInMeters",context)){ %>
                                      <div class="form-inline">
                                        <label class="control-label">
                                          <%=props.getProperty("submit_depth")%>
                                        </label>
                                      ...
                                      <% } if(CommonConfiguration.showProperty("maximumElevationInMeters",context)){ %>
                                        <div class="form-inline">
                                          <label class="control-label">
                                            <%=props.getProperty("submit_elevation")%>
                                          </label>
                      ...
                      <fieldset>
                        <div class="row">
                          <div class="col-xs-12 col-lg-6">
                            <h3>
                              <%=props.getProperty("aboutYou") %>
                            </h3>
                            <p class="help-block">
                              <%=props.getProperty("submit_contactinfo") %>
                            </p>
                            <div class="form-group form-inline" id="test2">
                              ...
                              <div class="col-xs-6 col-lg-8">
                                <input class="form-control" name="submitterName" type="text" id="submitterName"
                                  size="24" value="<%=submitterName %>">
                              </div>
                            </div>
                            ...
                            <div class="form-group form-inline required" id="test1">
                              <div class="col-xs-6 col-md-4">
                                <label class="control-label">
                                  <%=props.getProperty("submit_email") %>
                                </label>
                              </div>
                              <div class="col-xs-6 col-lg-8">
                                <input class="form-control" name="submitterEmail" type="text" id="submitterEmail"
                                  size="24" value="<%=submitterEmail %>"
                                  onChange="$('.required-missing').removeClass('required-missing');">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-xs-12 col-lg-6">
                            <h3>
                              <%=props.getProperty("aboutPhotographer") %>
                            </h3>
                            ...
                            <div class="form-group form-inline" id="test3">
                              ...
                              <div class="col-xs-6 col-lg-8">
                                <input class="form-control" name="photographerName" type="text" id="photographerName"
                                  size="24">
                              </div>
                            </div>
                            ...
                            <div class="form-group form-inline" id="test4">
                              ...
                              <div class="col-xs-6 col-lg-8">
                                <input class="form-control" name="photographerEmail" type="text" id="photographerEmail"
                                  size="24">
                              </div>
                            </div>
                          </div>
                        ...
                        <fieldset>
                          ...
                          <div class="form-group">
                            <div class="col-xs-6 col-md-4">
                              <label class="control-label">
                                <%=props.getProperty("submit_comments") %>
                              </label>
                            </div>
                            <div class="col-xs-6 col-lg-8">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-6 col-lg-8">
                              <select class="form-control" name="genusSpecies" id="genusSpecies"
                                onChange="$('.required-missing').removeClass('required-missing'); return true;">
                                <option value="" selected="selected">
                                  <%=props.getProperty("submit_unsure") %>
                                </option>
                                <% List<String> species=CommonConfiguration.getIndexedPropertyValues("genusSpecies",
                                  context);
                                  ...
                                  for(int q=0;q<numGenusSpeciesProps;q++){ String currentGenuSpecies="genusSpecies" +q;
                                    String
                                    showCommonNames=CommonConfiguration.getProperty("showCommonSpeciesNames",context);
                                    if(CommonConfiguration.getProperty(currentGenuSpecies,context)!=null){ String
                                    commonNameLabel="" ; if (showCommonNames!=null&&"true".equals(showCommonNames)) {
                                    String commonNameVal=CommonConfiguration.getProperty("commonName"+q,context); if
                                    (commonNameVal!=null&&!"null".equals(commonNameVal)&&!"".equals(commonNameVal)) {
                                    commonNameLabel=" (" +commonNameVal+")"; } } %>
                                    <option value="<%=CommonConfiguration.getProperty(currentGenuSpecies,context)%>"
                                      <%=selected %>>
                                      <%=CommonConfiguration.getProperty(currentGenuSpecies,context).replaceAll("_"," ")+commonNameLabel%></option>
                               <%
...
%>
  ...
  <h4 class=" accordion">
                                        <a href="javascript:animatedcollapse.toggle('advancedInformation')"
                                          style="text-decoration:none">
                                          <img src="images/Black_Arrow_down.png" width="14" height="14" border="0"
                                            align="absmiddle">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-xs-6 col-lg-8">
                                                <label class="radio-inline">
                                                  ...
                                                  <%=props.getProperty("submit_male") %>
                                                </label>
                                                <label class="radio-inline">
                                                  <input type="radio" name="sex" value="female">
                                                  <%=props.getProperty("submit_female") %>
                                                </label>
                                                <label class="radio-inline">
                                                  <input name="sex" type="radio" value="unknown" checked="checked">
                                                  <%=props.getProperty("submit_unsure") %>
                                                </label>
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-xs-6 col-lg-8">
                                                <select class="form-control" name="livingStatus" id="livingStatus">
                                                  <option value="alive" selected="selected">
                                                    <%=props.getProperty("alive") %>
                                                  </option>
                                                  <option value="dead">
                                                    <%=props.getProperty("dead") %>
                                                  </option>
                                                </select>
                                              </div>
                                            </div>
        ...
        -->
                                            ...
                                            <div class="form-group">
                                              <div class="col-xs-6 col-md-4">
                                                <label class="control-label">
                                                  <%=props.getProperty("alternate_id") %>
                                                </label>
                                              </div>

                                              <div class="col-xs-6 col-lg-8">
                                                <input class="form-control" name="alternateID" type="text"
                                                  id="alternateID" size="75">
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              <div class="col-xs-6 col-md-4">
                                                <label class="control-label">
                                                  <%=props.getProperty("occurrence_id") %>
                                                </label>
                                              </div>

                                              <div class="col-xs-6 col-lg-8">
                                                <input class="form-control" name="occurrenceID" type="text"
                                                  id="occurrenceID" size="75">
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              <div class="col-xs-6 col-md-4">
                                                <label class="control-label">
                                                  <%=props.getProperty("submit_behavior") %>
                                                </label>
                                              </div>

                                              <div class="col-xs-6 col-lg-8">
                                                <input class="form-control" name="behavior" type="text" id="behavior"
                                                  size="75">
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              <div class="col-xs-6 col-md-4">
                                                <label class="control-label">
                                                  <%=props.getProperty("submit_scars") %>
                                                </label>
                                              </div>

                                              <div class="col-xs-6 col-lg-8">
                                                <input class="form-control" name="scars" type="text" id="scars"
                                                  size="75">
                                              </div>
                                            </div>
                                            ...
                                            <% if(CommonConfiguration.showProperty("showLifestage",context)){ %>
                                              <div class="form-group">
                                                <div class="col-xs-6 col-md-4">
                                                  <label class="control-label">
                                                    <%=props.getProperty("lifeStage") %>
                                                  </label>
                                                </div>
                                                <div class="col-xs-6 col-lg-8">
                                                  <select name="lifeStage" id="lifeStage">
                                                    <option value="" selected="selected"></option>
                                                    <% boolean hasMoreStages=true; int stageNum=0; while(hasMoreStages){
                                                      String currentLifeStage="lifeStage" +stageNum;
                                                      if(CommonConfiguration.getProperty(currentLifeStage,context)!=null){
                                                      %>

                                                      <option
                                                        value="<%=CommonConfiguration.getProperty(currentLifeStage,context)%>">
                                                        <%=CommonConfiguration.getProperty(currentLifeStage,context)%>
                                                      </option>
                                                      <% stageNum++; } else{ hasMoreStages=false; } } %>
                                                  </select>
                                                </div>
                                              </div>
                                          ...
                                          <% pageContext.setAttribute("showMeasurements",
                                            CommonConfiguration.showMeasurements(context)); %>
                                            <c:if test="${showMeasurements}">
                                              <hr>
                                              <fieldset>
                                                <% pageContext.setAttribute("items",
                                                  Util.findMeasurementDescs(langCode,context));
                                                  pageContext.setAttribute("samplingProtocols",
                                                  Util.findSamplingProtocols(langCode,context)); %>

                                                  <div class="form-group">
                                                    <h3>
                                                      <%=props.getProperty("measurements") %>
                                                    </h3>
                                                    ...
                                                    <div class="col-xs-12 col-lg-8">
                                                      <table class="measurements">
                                                        ...
                                                        <c:forEach items="${items}" var="item">
                                                          <tr>
                                                            <td>${item.label}</td>
                                                            <td><input name="measurement(${item.type})"
                                                                id="${item.type}" /><input type="hidden"
                                                                name="measurement(${item.type}units)"
                                                                value="${item.units}" /></td>
                                                            <td>
                                                            ...
                                                            <c:if test="${!empty samplingProtocols}">
                                                              <td>
                                                                <select
                                                                  name="measurement(${item.type}samplingProtocol)">
                                                                  <c:forEach items="${samplingProtocols}"
                                                                    var="optionDesc">
                                                                    <option value="${optionDesc.name}">
                                                                      <c:out value="${optionDesc.display}" />
                                                                    </option>
                                                                  </c:forEach>
                                                                </select>
                                                              </td>
                                            ...
                                            <fieldset>
                                              <h3>
                                                <%=props.getProperty("tags") %>
                                              </h3>
                                              <% pageContext.setAttribute("showMetalTags",
                                                CommonConfiguration.showMetalTags(context));
                                                pageContext.setAttribute("showAcousticTag",
                                                CommonConfiguration.showAcousticTag(context));
                                                pageContext.setAttribute("showSatelliteTag",
                                                CommonConfiguration.showSatelliteTag(context));
                                                pageContext.setAttribute("metalTags",
                                                Util.findMetalTagDescs(langCode,context)); %>
                                                ...
                                                <c:if test="${showMetalTags and !empty metalTags}">
                                                  ...
                                                  <div class="form-group">
                                                    <div class="col-xs-6 col-md-4">
                                                      <label>
                                                        <%=props.getProperty("physicalTags") %>
                                                      </label>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-lg-8">
                                                      <table class="metalTags">
                                                        <tr>
                                                          ...
                                                          <th>
                                                            <%=props.getProperty("tagNumber") %>
                                                          </th>
                                                        </tr>
                                                        <c:forEach items="${metalTags}" var="metalTagDesc">
                                                          <tr>
                                                            <td>
                                                              <c:out value="${metalTagDesc.locationLabel}:" />
                                                            </td>
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-lg-8">
                                                      <table class="acousticTag">
                                                        <tr>
                                                          <td>
                                                            <%=props.getProperty("serialNumber") %>
                                                          </td>
                                                ...
                                                <c:if test="${showSatelliteTag}">
                                                  <div class="form-group">
                                                    <div class="col-xs-6 col-md-4">
                                                      <label>
                                                        <%=props.getProperty("satelliteTag") %>
                                                      </label>
                                                    </div>
                                                    <% pageContext.setAttribute("satelliteTagNames",
                                                      Util.findSatelliteTagNames(context)); %>
                                                      <div class="col-xs-12 col-lg-8">
                                            ...
                                            <div class="form-group">
                                              <label class="control-label">
                                                <%=props.getProperty("otherEmails") %>
                                              </label>
                                              <input class="form-control" name="informothers" type="text"
                                                id="informothers" size="75">
                                              <p class="help-block">
                                                <%=props.getProperty("multipleEmailNote") %>
                                              </p>
                                            </div>
                                        </div>
	...
	return true;
                                            ...
                                            <p class="text-center">
                                              <button id="submitEncounterButton" class="large" type="submit"
                                            ...
                                            <p>&nbsp;</p>
                                            <%if (request.getRemoteUser() !=null) {%>
                                              <input name="submitterID" type="hidden"
