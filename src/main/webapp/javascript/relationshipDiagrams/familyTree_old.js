...
function setupFamilyTree(individualID) {
  ...
  d3.json(wildbookGlobals.baseUrl + "/api/jdoql?"+encodeURIComponent("SELECT FROM org.ecocean.social.Relationship WHERE (this.type == \"social grouping\") && (this.markedIndividualName1 == \"" + individualID + "\" || this.markedIndividualName2 == \"" + individualID + "\")"), function(error, json){

      console.log("JSON Datas:");
      console.log(json); //TODO(jdonov): Remove
