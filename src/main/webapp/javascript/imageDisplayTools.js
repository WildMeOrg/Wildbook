...
function mkImg(maJson) {
    ...
    return '<img class="lazyload" id="figure-img-' + maJson.id + ':' + wildbook.uuid() + '" data-enh-mediaAssetId="' + maJson.id + '" src="/cust/mantamatcher/img/individual_placeholder_image.jpg" data-src="' + url + '" itemprop="contentUrl" alt="Image description"/>';
}
