			...
			
{
	...
	if(enc.getSpotImageFileName()!=null){spotFilenameURL="http://www.grouperspotter.org/wildbook_data_dir/encounters/"+Encounter.subdir(enc.getCatalogNumber())+"/"+enc.getSpotImageFileName();}
