			...
			
{
	...
	if(enc.getSpotImageFileName()!=null){spotFilenameURL="https://seals.wildme.org/caribwhale_data_dir/encounters/"+Encounter.subdir(enc.getCatalogNumber())+"/"+enc.getSpotImageFileName();}
