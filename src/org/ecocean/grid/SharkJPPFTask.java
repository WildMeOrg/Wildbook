...
//public class scanWorkItem implements java.io.Serializable{
	 ...
	 */
	public SharkJPPFTask() {}
	
	//test comment
	
	public SharkJPPFTask(Encounter newEnc, Encounter existingEnc, String uniqueNum, String taskID, Properties props) {
		...
		if(secondRunString.equals("false")){secondRun=false;}
		this.rightScan=false;
		String rightScanString=(String)props.get("rightScan");
		if(rightScanString.equals("true")){rightScan=true;}
	 ...
	 */
	public void setStartTime(long newStartTime){this.startTime=newStartTime;}
	...
	public boolean isRightScan(){return rightScan;}
	
	public void setExistingEncounter(EncounterLite el){this.existingEncounter=el;}
	
	public void setNewEncounter(EncounterLite el){this.newEncounter=el;}
}
