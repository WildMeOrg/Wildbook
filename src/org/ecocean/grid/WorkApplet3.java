				...
				if(successfulConnect){
					...
					//kick it like Poison!
						...
						try{
							...
							if(!getParameter("encounter").equals("null")) status.setMaximum(swi.getTotalWorkItemsInTask());
							if(!getParameter("encounter").equals("null")) status.setValue(swi.getWorkItemsCompleteInTask());
