...
public class AdoptionForm extends ActionForm {
		...
		public void setAdopterName(String an){this.adopterName=an;}
		
		public String getAdopterAddress(){return adopterAddress;}
		public void setAdopterAddress(String an){this.adopterAddress=an;}
		
		public String getAdopterEmail(){return adopterEmail;}
		public void setAdopterEmail(String an){this.adopterEmail=an;}
		
		public String getAdopterImage(){return adopterImage;}
		public void setAdopterImage(String an){this.adopterImage=an;}
		
		public String getAdoptionStartDate(){return adoptionStartDate;}
		public void setAdoptionStartDate(String an){this.adoptionStartDate=an;}
		
		public String getAdoptionEndDate(){return adoptionEndDate;}
		public void setAdoptionEndDate(String an){this.adoptionEndDate=an;}
		
		public String getAdopterQuote(){return adopterQuote;}
		public void setAdopterQuote(String an){this.adopterQuote=an;}
		
		public String getAdoptionManager(){return adoptionManager;}
		public void setAdoptionManager(String an){this.adoptionManager=an;}
		
		public String getShark(){return shark;}
		public void setShark(String an){this.shark=an;}
		
		public String getEncounter(){return encounter;}
		public void setEncounter(String an){this.encounter=an;}
		
		public String getNotes(){return notes;}
		public void setNotes(String an){this.notes=an;}
