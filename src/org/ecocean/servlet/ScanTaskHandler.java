...
public class ScanTaskHandler extends HttpServlet {
			...
			if ((action.equals("removeTask"))&&(request.getParameter("taskID")!=null)) {
				...
				if((myShepherd.isScanTask(request.getParameter("taskID")))&&(deletePermission)){
					...
					if(!locked) {
						...
						out.println("<p><a href=\"http://"+CommonConfiguration.getURLLocation()+"/appadmin/scanTaskAdmin.jsp\">Return to scanTask administration page.</a></p>\n");
