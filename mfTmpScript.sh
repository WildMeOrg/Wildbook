...
mvn clean install -DskipTests -Dmaven.javadoc.skip=true && cp /Users/mf/Desktop/Wildbook/target/wildbook-7.0.0-EXPERIMENTAL.war /usr/local/apache-tomcat-7.0.79/webapps/wildbook.war
