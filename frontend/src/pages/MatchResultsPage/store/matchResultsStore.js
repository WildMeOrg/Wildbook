...
export default class MatchResultsStore {
  // --- observable state (API & view state) ---
  _viewMode = "individual"; // "individual" | "image"
  _encounterId = "";
  _individualId = null;
  _projectName = "";
  _numResults = 12; // how many prospects to request from backend
  _numCandidates = 0;
  _matchDate = null;
  _thisEncounterImageUrl = "";
  _possibleMatchImageUrl = "";
  _selectedMatchImageUrlByAlgo = new Map(); // reserved for per-algorithm selection
  _selectedMatch = [];
  _taskId = null;
  _newIndividualName = "";
